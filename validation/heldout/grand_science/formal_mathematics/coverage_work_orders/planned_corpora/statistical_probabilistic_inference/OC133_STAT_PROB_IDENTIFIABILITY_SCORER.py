...
CONFIG = {"corpus_key": "statistical_probabilistic_inference", "executed_name": "OC133_STAT_PROB_IDENTIFIABILITY_EXECUTED_PROOF_CORPUS.json", "expected_function": "stat_prob", "input_name": "OC133_STAT_PROB_IDENTIFIABILITY_FORMAL_INPUTS.json", "lock_name": "OC133_STAT_PROB_IDENTIFIABILITY_WITHHELD_AGGREGATES.lock.json", "minimum_rows": 20, "verdict_field": "formal_derivation_verdict"}
