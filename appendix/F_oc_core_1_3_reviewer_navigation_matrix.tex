...
This appendix gives reviewers the first inspection stop and the decisive check
...
Where does the proof-bearing route begin? & Sections~\ref{sec:results},~\ref{sec:oc13-theorem-roadmap} & Axiom 3.2; Axiom 3.3; Definitions 12.1, 12.5, 12.6; Source Theorem~3; Source Corollary~3.2. \\
...
Why is the hierarchy fixed as \(K_0,\dots,K_{12}\)? & Sections~\ref{sec:oc13-foundational-consistency},~\ref{sec:klevels-full},~\ref{sec:oc13-worked-examples} & Upper levels carry nondecorative higher-order roles. \\
\bottomrule
\end{tabular}
\par}
