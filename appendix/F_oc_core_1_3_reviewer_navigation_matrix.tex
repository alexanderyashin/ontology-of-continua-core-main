...
Start with the row that matches the objection, inspect the primary route, and
use the decisive-check column as the pass/fail test.
...
\toprule
\textbf{Reviewer question} & \textbf{Primary route to inspect} & \textbf{Decisive check} \\
\midrule
