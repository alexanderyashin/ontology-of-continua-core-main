...
Where does the proof-bearing route begin? & Sections~\ref{sec:results},~\ref{sec:oc13-theorem-roadmap} & Verify the positive chain \(3.2+12.1+12.3+12.4\to\) Source Theorem~3 \(\to\) Lemma~1, then Lemma~1 \(+\) Definition~12.5 \(\to\) Lemma~2 \(\to\) Theorem~A; inspect Axiom~3.3, Definition~12.6, and Source Corollary~3.2 only as the companion rebirth-control branch. \\
...
What remains outside scope? & Sections~\ref{sec:discussion},~\ref{sec:oc13-publication-boundary}; Appendix~\ref{sec:oc13-journal-core-bridge} & Pass only if excluded theorem families and open projections remain outside the positive proof body. \\
\bottomrule
\end{tabular}
\par}
