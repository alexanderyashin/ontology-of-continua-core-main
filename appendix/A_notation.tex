...
\begin{description}
  ...
  \item[\(K_{11}\)] Trans-meta-theoretical continua (frameworks comparing
        and governing model families).
  \item[\(K_{12}\)] Closure-level continua (global boundary and limit
        structures for the full stack).
\end{description}
