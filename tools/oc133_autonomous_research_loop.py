...
def focused_checks() -> list[dict[str, Any]]:
    return [
        command([sys.executable, "-m", "py_compile", "tools/materialize_oc_core_1_3_3_v12_closure.py", "proofs/finite_model_checks/run_finite_model_checks.py", "tools/oc133_autonomous_research_loop.py", "tools/oc133_capability_repair_executor.py", "tools/oc133_vulnerability_class_remediator.py", "tools/oc133_refresh_lean_certificate.py", "tools/oc133_grand_toe_formal_obligations.py", "tools/oc133_grand_promotion_contract.py", "tools/oc133_acquisition_planner_runner.py", "tools/oc133_harvester_runner.py", "tools/oc133_domain_evidence_executor_runner.py", "tools/oc133_grand_empirical_evidence_factory.py", "tools/oc133_modern_science_comparator_factory.py", "validation/grand_science/run_grand_empirical_gate.py", "benchmarks/modern_science/validate_modern_science_register.py"], timeout=120),
