...
\node[supportnode] (rightsupport) at (4.9, 3.2) {Axiom 3.3\\Definitions 12.5, 12.6};
...
\node[excludednode] (excludedlift) at (7.2, -2.35) {Excluded lift-heavy family\\not in the positive bounded route};
...
\draw[dashed, ->] (excludedlift.south west) .. controls +(-0.2,-1.0) and +(1.0,0.5) .. (theorema.east);

\node[anchor=north west, align=left] at (-1.0, -6.2) {\footnotesize Solid arrows: admitted support chain\\\footnotesize Dashed arrows: excluded temptation route};
