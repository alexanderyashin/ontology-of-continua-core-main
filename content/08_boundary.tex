...
\subsection{Formal Definition of \texorpdfstring{\texorpdfstring{$\partial\Omega(K)$}{\partial\Omega(K)}}{boundary}}
...
Let \(n(s)\) denote the outward normal to \(\partial\Omega(K)\) at a point \(s\)
