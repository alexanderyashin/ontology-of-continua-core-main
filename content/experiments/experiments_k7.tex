...
\subsection{Objectives of the \texorpdfstring{$K_7$}{K_7} Experimental Programme}
...
\subsection{Type~I Experiments: Trust Dynamics and Thresholds}
...
\subsection{Type~II Experiments: Normative Cycles and Social Coherence}
...
\subsection{Type~III Experiments: Communication Networks and Flow Stability}
...
\subsection{Type~IV Experiments: Institutional Stability and Collapse}
...
\subsection{Type~V Experiments: Resource Flows and Social Gradients}
...
\subsection{Type~VI Experiments: Social Identity and Fragmentation}
...
\subsection{Type~VII Experiments: Collapse and Reorganisation of Social Continua}
