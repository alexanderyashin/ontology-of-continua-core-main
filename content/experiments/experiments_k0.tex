...
\subsection{Nature of \texorpdfstring{$K_0$}{K_0} Experiments}
...
\subsection{Type~I Logical Experiments: Axiom Consistency Checks}
...
\subsection{Type~II Domain of Definition Experiments}
...
\subsection{Type~III Transition Experiments for $\Psi_{0\to 1}$}
...
\subsection{Type~IV Meta–Consistency Experiments}
