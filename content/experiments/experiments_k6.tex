...
\subsection{Objectives of the \texorpdfstring{$K_6$}{K_6} Experimental Programme}
...
\subsection{Type~I Experiments: Representational Capacity and Axes}
...
\subsection{Type~II Experiments: Binding and Multi-Feature Integration}
...
\subsection{Type~III Experiments: Prediction and Prediction-Error Dynamics}
...
\subsection{Type~IV Experiments: Internal Models and Coherence Testing}
...
\subsection{Type~V Experiments: Memory Encoding, Storage and Retrieval}
...
\subsection{Type~VI Experiments: Flow Dynamics \texorpdfstring{$J_6$}{J_6} and Cognitive Load}
...
\subsection{Type~VII Experiments: Cognitive Collapse and Recovery}
