...
\subsection{Objectives of the \texorpdfstring{$K_9$}{K_9} Experimental Programme}
...
\subsection{Type~I Experiments: Paradigm Reconstruction and Coherence Thresholds}
...
\subsection{Type~II Experiments: Logical Framework Stress Tests}
...
\subsection{Type~III Experiments: Meta-Model Dynamics and Explanatory Power}
...
\subsection{Type~IV Experiments: Inconsistency Cascades and \texorpdfstring{$K_9$}{K_9} Collapse}
...
\subsection{Type~V Experiments: Cross-Disciplinary Meta-Theoretical Integration}
...
\subsection{Type~VI Experiments: Agent-Based Reasoning and Collective Cognition}
