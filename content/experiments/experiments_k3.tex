...
\subsection{Objectives of \texorpdfstring{$K_3$}{K_3} Experiments}
...
\subsection{Type~I Experiments: Structure of \texorpdfstring{$\Omega(K_3)$}{\Omega(K_3)}}
...
\subsection{Type~II Experiments: Activation Thresholds $\Theta_{\mathrm{chem}}$}
...
\subsection{Type~III Experiments: Reaction Flows $J_{\mathrm{chem}}$}
...
\subsection{Type~IV Experiments: Catalysis and Lowering of Thresholds}
...
\subsection{Type~V Experiments: Autocatalytic Sets (RAF Networks)}
...
\subsection{Type~VI Experiments: Failure and Collapse of Chemical Continua}
...
\subsection{Type~VII Experiments: Validation of the Operator $F_{2\rightarrow 3}$}
