...
\subsection{Objectives of the \texorpdfstring{$K_4$}{K_4} Experimental Programme}
...
\subsection{Type~I Experiments: Self-Assembly and Birth of \texorpdfstring{$\partial\Omega(K_4)$}{\partial\Omega(K_4)}}
...
\subsection{Type~II Experiments: Appearance and Stability of Gradients}
...
\subsection{Type~III Experiments: Transport Flows $J_{\mathrm{in/out}}$}
...
\subsection{Type~IV Experiments: Patch Dynamics and Spatial Graininess}
...
\subsection{Type~V Experiments: Bioenergetic and Buffering Cycles}
...
\subsection{Type~VI Experiments: Pre-Regulation and Signal Networks}
...
\subsection{Type~VII Experiments: Proto-Excitability and Early Electrical Dynamics}
...
\subsection{Type~VIII Experiments: Collapse of \texorpdfstring{$K_4$}{K_4} Continua}
