...
\section{Jets on \texorpdfstring{$K_6$}{K6}}
\label{sec:jets-k6}
...
\subsection{State fields and cognitive coordinates}
...
\subsection{Potentials and their jets}
...
\subsection{Jets of flows and cycles}
...
\subsection{Jets at the interface with \texorpdfstring{$K_5$}{K5}}
...
\subsection{Jets of thresholds and boundary deformations}
...
\subsection{Jets and the evolution of \texorpdfstring{$k_6(t)$}{k6(t)}}
