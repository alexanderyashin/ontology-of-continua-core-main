...
% ---------------------------------------------------------------
\subsection{P1: Predictions About the Birth of Model-Spaces}
...
% ---------------------------------------------------------------
\subsection{P2: Predictions Concerning Axes $A^{11}$}
...
% ---------------------------------------------------------------
\subsection{P3: Predictions About Potentials $P^{11}$}
...
% ---------------------------------------------------------------
\subsection{P4: Predictions for Transformation Flows $J^{11}$}
...
% ---------------------------------------------------------------
\subsection{P5: Predictions for Cycles $C^{11}$}
...
% ---------------------------------------------------------------
\subsection{P6: Predictions for Continuumness $k(K_{11})$}
...
% ---------------------------------------------------------------
\subsection{P7: Predictions for Transition to $K_{12}$}
