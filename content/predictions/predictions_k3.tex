...
% ---------------------------------------------------------------
\subsection{P1: Predictions Concerning Geometry and Dimensionality}
...
% ---------------------------------------------------------------
\subsection{P2: Predictions Concerning Connectivity and Percolation}
...
\paragraph{(P3.12) Dimensional Threshold for $K_2\to K_3$.}
...
% ---------------------------------------------------------------
\subsection{P5: Predictions Concerning Boundary, Collapse and Topological Effects}
...
\paragraph{(P3.20) Necessary Condition for $K_3\to K_4$.}
Transition requires:
\[
