...
% ---------------------------------------------------------------
\subsection{P1: Predictions on the Birth of \texorpdfstring{$K_9$}{K_9}}
...
% ---------------------------------------------------------------
\subsection{P2: Predictions Concerning Axes \texorpdfstring{$A^9$}{A^9}}
...
% ---------------------------------------------------------------
\subsection{P3: Predictions for Potentials \texorpdfstring{$P^9$}{P^9}}
...
% ---------------------------------------------------------------
\subsection{P4: Predictions for Flows \texorpdfstring{$J^9$}{J^9}}
...
% ---------------------------------------------------------------
\subsection{P5: Predictions for Cycles \texorpdfstring{$C^9$}{C^9}}
...
% ---------------------------------------------------------------
\subsection{P6: Predictions for Stability and \texorpdfstring{$k(K_9)$}{k(K_9)}}
