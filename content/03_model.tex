...
The tuple \(K=(\Omega,A,P,J,\Theta,\partial\Omega,C,k)\) is the public interface
used by this release. Core 1.3.3 does not promote a public theorem of global
verdict-invariant minimality. Instead it records a narrower public route: each
tuple component has a replayable keep/drop witness showing why the component
cannot be removed from the declared release verdict suite without changing at
least one relevant verdict.
