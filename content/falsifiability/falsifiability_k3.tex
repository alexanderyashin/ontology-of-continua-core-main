...
\paragraph{(F3.1) $\Omega(K_3)$ is empty.}
...
\paragraph{(F3.14) RAF cycles conflict with $\partial\Omega(K_3)$.}
...
\paragraph{(F3.22) No embedding into $K_2$.}
...
\paragraph{(F3.23) $F_3$ is undefined.}
If no coherent dynamical rules exist, the continuum collapses.

\paragraph{(F3.24) $F_3$ violates admissibility.}
...
% ================================================================
\subsection{Falsifiability via Transition $K_2 \to K_3$}
% ================================================================
