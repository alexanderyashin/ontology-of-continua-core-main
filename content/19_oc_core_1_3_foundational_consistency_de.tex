...
The point is that the source corpus itself already distinguishes:
...
\item a fürther stratum in which operators, meta-logics, and model-spaces
...
as \(K_0,\dots,K_{10}\). Stopping at \(K_{10}\) leaves the öffentlich source corpus
...
\item \textbf{Derived statements} are theorem-bearing rows with explicit support
...
\subsection{Proof-bearing and Nichtbehauptung layers}
...
\item the Core 1.3 repair layer that clarifies witness discipline, theorem
      fate, chronology, and öffentlichation boundary;
\item the bounded Nichtbehauptung layer that states what the present release does not
...
full theory, the reader ladder, the appendices, and the explicit öffentlichation
boundary in one place.
The journal-core Artikel is narrower by design.
Its role is to extract one defensible theorem-bearing route for editorial
...
with explicit preservation of notation, Nichtbehauptung boundaries, and theorem scope.
The shorter Artikel may omit detail.
