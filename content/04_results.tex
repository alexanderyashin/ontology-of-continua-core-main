...
Unlike earlier drafts of the Core, this chapter is not a placeholder: it presents the canonical consequences of the Ontology of Continua (OC) axioms and operators, as consolidated from earlier internal runs and reorganised for Core~1.1.
