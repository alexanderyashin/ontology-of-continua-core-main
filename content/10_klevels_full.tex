...
\section{Full Hierarchy of Continua \texorpdfstring{\texorpdfstring{$K_0$}{K\_0}–$K_{10}$}{K0–K10}}
...
\hline
\end{tabular}
\caption{Global overview of continua \texorpdfstring{\(K_0\)}{K0}–\(K_{10}\).}
...
% ====================================================================
\subsection{Levels \texorpdfstring{\texorpdfstring{$K_9$}{K\_9}–$K_{10}$}{K9–K10}: Theoretical and Meta-Theoretical Continua}
% ====================================================================
