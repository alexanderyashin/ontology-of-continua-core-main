...
\hline
\end{tabular}
\caption{Global overview of continua \(K_0\)–\(K_{10}\).}
...
\subsubsection{Level \(K_3\): Chemical Continua}
...
\subsubsection{Level \(K_4\): Protocellular Continua}
...
\subsubsection{Level \(K_7\): Social Continua}
...
\subsubsection{Level \(K_8\): Civilizational Continua}
...
\subsubsection{Level \(K_9\): Theoretical Continua}
