...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/09_thresholds.tex
% ====================================================================
% FILE: content/09_thresholds.tex
% Extended Threshold Landscape — Core 1.3 (Final Version)
% ====================================================================
...
\begin{itemize}
    ...
    \item prediction–error bifürcations in \(K_6\),
    \item institutional bifürcations in \(K_7\).
\end{itemize}
...
\begin{itemize}
    ...
    \item \(\Theta_{\rm crit}\): classical bifürcations and loss of stability.
\end{itemize}
