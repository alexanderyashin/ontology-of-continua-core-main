...
\section{\texorpdfstring{$M_3$}{M_3} Overview}
...
% ---------------------------------------------------------------
\subsection*{1. Admissible Configuration Space \texorpdfstring{$\Omega(M_3)$}{\Omega(M_3)}}
...
% ---------------------------------------------------------------
\subsection*{2. Admissible Axes \texorpdfstring{$A(M_3)$}{A(M_3)}}
...
% ---------------------------------------------------------------
\subsection*{3. Potentials \texorpdfstring{$P(M_3)$}{P(M_3)}}
...
% ---------------------------------------------------------------
\subsection*{4. Thresholds \texorpdfstring{$\Theta(M_3)$}{\Theta(M_3)}}
...
% ---------------------------------------------------------------
\subsection*{5. Flows \texorpdfstring{$J(M_3)$}{J(M_3)}}
...
% ---------------------------------------------------------------
\subsection*{6. Cycles and Reaction Networks}
...
% ---------------------------------------------------------------
\subsection*{7. Boundary \texorpdfstring{$\partial\Omega(M_3)$}{\partial\Omega(M_3)} and Collapse}
...
% ---------------------------------------------------------------
\subsection*{8. Relation to \texorpdfstring{$M_2$}{M_2} and \texorpdfstring{$M_4$}{M_4}}
