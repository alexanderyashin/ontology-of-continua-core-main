...
% ---------------------------------------------------------------
\subsection*{1. Admissible Configuration Space $\Omega(M_6)$}
...
% ---------------------------------------------------------------
\subsection*{2. Admissible Axes $A(M_6)$}
...
% ---------------------------------------------------------------
\subsection*{4. Thresholds $\Theta(M_6)$}
...
% ---------------------------------------------------------------
\subsection*{7. Boundary $\partial\Omega(M_6)$}
...
% ---------------------------------------------------------------
\subsection*{8. Relation to $M_5$ and $M_7$}
