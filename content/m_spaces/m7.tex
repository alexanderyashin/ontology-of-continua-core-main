...
\section{\texorpdfstring{$M_7$}{M_7} Overview}
...
% ---------------------------------------------------------------
\subsection*{1. Admissible Configuration Space \texorpdfstring{$\Omega(M_7)$}{\Omega(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{2. Admissible Axes \texorpdfstring{$A(M_7)$}{A(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{3. Potentials \texorpdfstring{$P(M_7)$}{P(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{4. Thresholds \texorpdfstring{$\Theta(M_7)$}{\Theta(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{5. Flows \texorpdfstring{$J(M_7)$}{J(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{6. Cycles \texorpdfstring{$C(M_7)$}{C(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{7. Boundary \texorpdfstring{$\partial\Omega(M_7)$}{\partial\Omega(M_7)}}
...
% ---------------------------------------------------------------
\subsection*{8. Relation to \texorpdfstring{$M_6$}{M_6} and \texorpdfstring{$M_8$}{M_8}}
