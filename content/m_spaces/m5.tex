...
\section{\texorpdfstring{$M_5$}{M_5} Overview}
...
% ---------------------------------------------------------------
\subsection*{1. Admissible Configuration Space \texorpdfstring{$\Omega(M_5)$}{\Omega(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{2. Admissible Axes \texorpdfstring{$A(M_5)$}{A(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{3. Potentials \texorpdfstring{$P(M_5)$}{P(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{4. Thresholds \texorpdfstring{$\Theta(M_5)$}{\Theta(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{5. Flows \texorpdfstring{$J(M_5)$}{J(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{6. Cycles in \texorpdfstring{$M_5$}{M_5}}
...
% ---------------------------------------------------------------
\subsection*{7. Boundary \texorpdfstring{$\partial\Omega(M_5)$}{\partial\Omega(M_5)}}
...
% ---------------------------------------------------------------
\subsection*{8. Relation to \texorpdfstring{$M_4$}{M_4} and \texorpdfstring{$M_6$}{M_6}}
