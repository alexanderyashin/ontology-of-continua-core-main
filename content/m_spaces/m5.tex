...
% ---------------------------------------------------------------
\subsection*{1. Admissible Configuration Space $\Omega(M_5)$}
...
% ---------------------------------------------------------------
\subsection*{2. Admissible Axes $A(M_5)$}
...
% ---------------------------------------------------------------
\subsection*{4. Thresholds $\Theta(M_5)$}
...
% ---------------------------------------------------------------
\subsection*{7. Boundary $\partial\Omega(M_5)$}
...
% ---------------------------------------------------------------
\subsection*{8. Relation to $M_4$ and $M_6$}
