...
\subsubsection{\texorpdfstring{$M_4$}{M_4} Overview}
...
% ---------------------------------------------------------------
\subsubsection*{1. Admissible Configuration Space \texorpdfstring{$\Omega(M_4)$}{\Omega(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{2. Admissible Axes \texorpdfstring{$A(M_4)$}{A(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{3. Potentials \texorpdfstring{$P(M_4)$}{P(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{4. Thresholds \texorpdfstring{$\Theta(M_4)$}{\Theta(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{5. Flows \texorpdfstring{$J(M_4)$}{J(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{6. Cycles in \texorpdfstring{$M_4$}{M_4}}
...
% ---------------------------------------------------------------
\subsubsection*{7. Boundary \texorpdfstring{$\partial\Omega(M_4)$}{\partial\Omega(M_4)}}
...
% ---------------------------------------------------------------
\subsubsection*{8. Relation to \texorpdfstring{$M_3$}{M_3} and \texorpdfstring{$M_5$}{M_5}}
