...
\section{\texorpdfstring{$M_1$}{M_1} Overview}
...
\subsection*{1. Structure of \texorpdfstring{$\Omega(M_1)$}{\Omega(M_1)}}
...
\subsection*{2. Admissible Axes in \texorpdfstring{$M_1$}{M_1}}
...
\subsection*{5. Admissible Flows and Proto-Dynamics}
...
\subsection*{6. Collapse and Boundary of \texorpdfstring{$M_1$}{M_1}}
...
\subsection*{7. Relation to \texorpdfstring{$K_0$}{K_0} and \texorpdfstring{$K_2$}{K_2}}
