...
and to outline trajectories for fürther development.
...
Core~1.3 does not claim to complete this programme.
It provides a coherent, minimal and extensible foundation on which more detailed, domain–specific developments can be built in subsequent Core and extension Artikels.
