...
Core~1.3 fixes the hierarchy as \(K_0\)–\(K_{12}\) because the публичный source
...
A global сводках is shown in Table~\ref{tab:klevels-сводках}.
