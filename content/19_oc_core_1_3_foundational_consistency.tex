...
\item remaining structural or interpretive content keeps the SPOT-recorded
      \occode{BRIDGE_ONLY}, \occode{FRAME_ONLY}, or \occode{EXTENSION}
      class.
\end{enumerate}
...
\item Structural and interpretive statements map to \occode{BRIDGE_ONLY},
      \occode{FRAME_ONLY}, or \occode{EXTENSION} as recorded by SPOT.
\item Frontier statements map to \occode{EXTENSION} unless explicitly refuted
      or promoted.
