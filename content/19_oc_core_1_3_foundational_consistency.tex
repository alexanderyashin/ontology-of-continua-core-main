...
empirical promotions. \texttt{BRIDGE\_ONLY} rows are evidence support rather
than public promoted closure unless and until the canonical promotion gates
convert them into theorem-native \texttt{PASS} rows. \texttt{EXTENSION} and
