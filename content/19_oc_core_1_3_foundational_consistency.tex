...
more than one class, use the following precedence rule before assigning its
public status:
\begin{enumerate}
\item explicit refutation maps first to \occode{REFUTED};
\item promoted empirical or derived content is inspected as
      \occode{THEOREM_NATIVE};
\item admitted axioms remain axiomatic premises;
\item frontier wording takes precedence over merely structural or interpretive
      wording unless promotion has occurred;
