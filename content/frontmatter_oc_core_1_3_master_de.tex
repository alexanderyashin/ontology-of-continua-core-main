...
% THEOREM_REVIEW_DOSSIER_REF: logion/k0/governance/status/external_llm_review_dossiers/OC_CORE_1_3_MONOGRAPH_THEOREM_REVIEW__DE__content_frontmatter_oc_core_1_3_master_de_tex.json
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
...
Publikation, Begutachtung, Übersetzung und spätere Projektion in ESTRA, Produkt-, Geschäfts- und
öffentliche Kanäle.
