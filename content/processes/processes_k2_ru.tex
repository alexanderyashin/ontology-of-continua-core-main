...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/processes/processes_k2.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{Structure of a \texorpdfstring{$K_2$}{K_2} Process}
...
% ---------------------------------------------------------------
\subsubsection{Percolation Processes}
...
% ---------------------------------------------------------------
\subsubsection{Causal Processes}
...
% ---------------------------------------------------------------
\subsubsection{Metric-Emergence Processes}
...
% ---------------------------------------------------------------
\subsubsection{Topological Processes}
...
\paragraph{Generative Operator \texorpdfstring{$\Psi_2$}{\Psi_2}.}
\[
...
\paragraph{Evolution Operator \texorpdfstring{$\Phi_2$}{\Phi_2}.}
...
\paragraph{Compositional Operator \texorpdfstring{$\Lambda_2$}{\Lambda_2}.}

Merges clusters, composes subnetworks, or lifts patterns from $K_1$ into
$K_2$ relational structure.

\paragraph{Universal Operator \texorpdfstring{$U_2$}{U_2}.}
...
\paragraph{Constraint Operator \texorpdfstring{$\Chi_2$}{\Chi_2}.}
...
% ---------------------------------------------------------------
\subsubsection{Structural Tension and Thresholds}
...
% ---------------------------------------------------------------
\subsubsection{Cycles on \texorpdfstring{$K_2$}{K_2}}
...
% ---------------------------------------------------------------
\subsubsection{Emergence of \texorpdfstring{$K_3$}{K_3} Processes}
