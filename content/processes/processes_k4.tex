...
% ---------------------------------------------------------------
\subsection{Membrane Formation, Deformation and Maintenance}
...
% ---------------------------------------------------------------
\subsection{Osmotic, Ionic and Chemical Gradient Processes}
...
% ---------------------------------------------------------------
\subsection{Metabolic and Autocatalytic Processes}
...
% ---------------------------------------------------------------
\subsection{Waste–Pressure–Tension Loop Processes}
...
% ---------------------------------------------------------------
\subsection{Processes of Permeability, Leakage, and Ion Balance}
...
% ---------------------------------------------------------------
\subsection{Pump-Driven Processes and Proto-Energy Handling}
...
% ---------------------------------------------------------------
\subsection{Processes of Boundary Excitability (Proto-AP)}
...
% ---------------------------------------------------------------
\subsection{Processes of Buffering and Homeostatic Regulation}
...
% ---------------------------------------------------------------
\subsection{Processes of Spatial Compartmentalisation}
...
% ---------------------------------------------------------------
\subsection{Processes Driving \texorpdfstring{$K_4 \to K_5$}{K_4 \to K_5} Transition}
...
% ---------------------------------------------------------------
\subsection{Collapse and Death of \texorpdfstring{$K_4$}{K_4}}
