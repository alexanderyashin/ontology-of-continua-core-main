...
% ---------------------------------------------------------------
\subsection{Definition of a \texorpdfstring{$K_1$}{K_1} Process}
...
% ---------------------------------------------------------------
\subsection{Types of Processes on \texorpdfstring{$K_1$}{K_1}}
...
% ---------------------------------------------------------------
\subsection{Role of Operators on \texorpdfstring{$K_1$}{K_1}}
...
% ---------------------------------------------------------------
\subsection{Emergence of \texorpdfstring{$K_2$}{K_2} Processes}
...
% ---------------------------------------------------------------
\subsection{Death of \texorpdfstring{$K_1$}{K_1} Processes}
