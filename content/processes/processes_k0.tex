...
% ---------------------------------------------------------------
\subsection{Nature of \texorpdfstring{$K_0$}{K_0} Processes}
...
% ---------------------------------------------------------------
\subsection{Structural Tension and Thresholds on \texorpdfstring{$K_0$}{K_0}}
...
% ---------------------------------------------------------------
\subsection{Birth of the First Axis and the Transition to \texorpdfstring{$K_1$}{K_1}}
...
% ---------------------------------------------------------------
\subsection{The Universal Schema for \texorpdfstring{$K_0$}{K_0} Processes}
...
% ---------------------------------------------------------------
\subsection{Death of \texorpdfstring{$K_0$}{K_0} Processes}
