...
% ---------------------------------------------------------------
\subsection{Structure of a \texorpdfstring{$K_2$}{K_2} Process}
...
% ---------------------------------------------------------------
\subsection{Cycles on \texorpdfstring{$K_2$}{K_2}}
...
% ---------------------------------------------------------------
\subsection{Emergence of \texorpdfstring{$K_3$}{K_3} Processes}
...
% ---------------------------------------------------------------
\subsection{Collapse and Death of \texorpdfstring{$K_2$}{K_2}}
