...
% ---------------------------------------------------------------
\subsection{Pattern Formation and Stabilisation Processes}
...
% ---------------------------------------------------------------
\subsection{Attractor Dynamics and State Convergence}
...
% ---------------------------------------------------------------
\subsection{Temporal Integration Processes}
...
% ---------------------------------------------------------------
\subsection{Multi-Step Information Flow Processes}
...
% ---------------------------------------------------------------
\subsection{Consistency Maintenance Processes}
...
% ---------------------------------------------------------------
\subsection{State-Update, Comparison, and Error-Correction Processes}
...
% ---------------------------------------------------------------
\subsection{S-Cell (S-Unit) Meaning-Formation Processes}
...
% ---------------------------------------------------------------
\subsection{Information Routing and Selective Attention Processes}
...
% ---------------------------------------------------------------
\subsection{Stability, Conflict and Cognitive Tension Processes}
...
% ---------------------------------------------------------------
\subsection{Memory Formation and Retrieval Processes}
...
% ---------------------------------------------------------------
\subsection{Proto-Representation and Internal Modelling Processes}
...
% ---------------------------------------------------------------
\subsection{Decision and Action-Preparation Processes}
...
% ---------------------------------------------------------------
\subsection{Noise-Driven Cognitive Fluctuation Processes}
...
% ---------------------------------------------------------------
\subsection{Transition Processes \texorpdfstring{$K_6 \to K_7$}{K_6 \to K_7}}
...
% ---------------------------------------------------------------
\subsection{Collapse and Death of \texorpdfstring{$K_6$}{K_6}}
