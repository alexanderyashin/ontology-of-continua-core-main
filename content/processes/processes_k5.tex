...
% ---------------------------------------------------------------
\subsection{Excitability and Ignition Processes}
...
% ---------------------------------------------------------------
\subsection{Action-Potential–Like Front Processes}
...
% ---------------------------------------------------------------
\subsection{Ion-Flux and Channel-Gating Processes}
...
% ---------------------------------------------------------------
\subsection{Recovery, Refractory and Reset Processes}
...
% ---------------------------------------------------------------
\subsection{Pump-Driven Restoration Processes}
...
% ---------------------------------------------------------------
\subsection{Energy Cycle Processes Supporting Excitability}
...
% ---------------------------------------------------------------
\subsection{Oscillatory and Pattern-Formation Processes}
...
% ---------------------------------------------------------------
\subsection{Compartmental and Network-Coupling Processes}
...
% ---------------------------------------------------------------
\subsection{Noise-Driven and Stochastic Activation Processes}
...
% ---------------------------------------------------------------
\subsection{Processes of Information-Carrying Capacity}
...
% ---------------------------------------------------------------
\subsection{Processes Driving the Transition \texorpdfstring{$K_5 \to K_6$}{K_5 \to K_6}}
...
% ---------------------------------------------------------------
\subsection{Collapse and Death of \texorpdfstring{$K_5$}{K_5}}
