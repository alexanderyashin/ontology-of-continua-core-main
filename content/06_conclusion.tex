...
\begin{itemize}
    ...
    \item A refined axiomatic formulation of the substrate level \(K_0\) and the generative operator \(\Psi_0\) defining the transition to \(K_1\).
...
Core~1.1 thus provides the minimum stable foundation on which all future work will build.
