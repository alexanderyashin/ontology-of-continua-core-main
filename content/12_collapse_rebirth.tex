...
\paragraph{Examples across \(K_3\)–\(K_5\).}
...
\paragraph{Cognitive collapse (\(K_6\)).}
...
\paragraph{Institutional collapse (\(K_7\)).}
...
\paragraph{Civilizational collapse (\(K_8\)).}
...
\paragraph{Theoretical and meta-theoretical collapse (\(K_9\)–\(K_{10}\)).}
