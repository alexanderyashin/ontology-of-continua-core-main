...
presents them in a compact, vertically consistent form suitable for Core~1.3.
...
This chapter completes the formal core of Core~1.3 by making explicit the
...
\label{sec:oc133-operators-scientific-closure-bridge}
