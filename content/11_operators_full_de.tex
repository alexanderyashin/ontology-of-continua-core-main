...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/11_operators_full.tex
% ====================================================================
...
\begin{itemize}
  ...
  \item local continuity: small changes in potentials or flows may induce small
        changes in thresholds, except at critical points where bifürcations are
        allowed.
\end{itemize}
...
\begin{itemize}
  ...
  \item allow for expansion, contraction and bifürcation of \(\Omega\);
...
the ground for fully quantitative models in subsequent extension Artikels.
