...
% Restored Full Version for Core 1.3
% ====================================================================
...
\]
Core~1.3 treats \(\Theta_{\mathrm{branch}}\) as a derived quantity rather
...
Taken together, the vertical hierarchy \(K_0\)–\(K_{10}\), the threshold
...
Core~1.3 fixes this global picture at the structural level. Subsequent
