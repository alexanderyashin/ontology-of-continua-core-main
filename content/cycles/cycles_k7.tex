...
\section{Cycles on \texorpdfstring{$K_7$}{K_7}}
\label{sec:cycles-k7}
...
\subsection{Cycle Metrics on \texorpdfstring{$K_7$}{K_7}}
...
\subsection{Collapse of \texorpdfstring{$K_7$}{K_7} Cycles}
...
\subsection{Continuity from \texorpdfstring{$K_6$}{K_6} to \texorpdfstring{$K_7$}{K_7}}
