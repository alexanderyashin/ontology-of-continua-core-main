...
\subsubsection{Cycles on \texorpdfstring{$K_0$}{K_0}}
\label{sec:cycles-k0}
...
\subsubsection{Absence of State Space and Time}
...
\subsubsection{Structural Reason}
...
\subsubsection{Implication for Higher Levels}
