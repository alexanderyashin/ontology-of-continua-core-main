...
\section{Cycles on \texorpdfstring{$K_4$}{K_4}}
\label{sec:cycles-k4}
...
\subsection{Classes of Cycles on \texorpdfstring{$K_4$}{K_4}}
...
\subsection{Metrics of Cycles at \texorpdfstring{$K_4$}{K_4}}
...
\subsection{Time and Recurrence Structure}
...
\subsection{Collapse and Viability of \texorpdfstring{$C(K_4)$}{C(K_4)}}
...
\subsection{Transition Toward \texorpdfstring{$K_5$}{K_5}}
