...
\section{Cycles on \texorpdfstring{$K_6$}{K_6}}
\label{sec:cycles-k6}
...
\subsection{Collapse of \texorpdfstring{$K_6$}{K_6} Cycles}
...
\subsection{Continuity from \texorpdfstring{$K_5$}{K_5} to \texorpdfstring{$K_6$}{K_6}}
