...
raw private feedback, raw model transcripts, unadjudicated theorem promotion, unsupported prediction wording

## Current No-Send Locks

- no publication
- no public push
- no Zenodo upload
- no DOI minting
- no email or outbound action
