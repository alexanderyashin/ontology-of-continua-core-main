...
- Current state: `PACKETIZED_OFFICIAL_REPLAY_EXECUTED_NOT_PASS_ELIGIBLE`
- Target state: `EMPIRICAL_HARD_CLOSED`
- Quantitative pass result: `OFFICIAL_EXECUTION_COMPLETE_NOT_PASS_ELIGIBLE`
- Next required action: `TIGHTEN_OFFICIAL_REPLAY_MODEL_AND_PROMOTE_NUMERICAL_PACKET`
- Replay status: `OFFICIAL_REPLAY_EXECUTED_NOT_PASS_ELIGIBLE`
