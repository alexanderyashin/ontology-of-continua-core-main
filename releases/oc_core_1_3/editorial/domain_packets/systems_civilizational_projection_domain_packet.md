...
- SYS_BENCH_003: process_system_regime_score | World Bank Indicators API | https://api.worldbank.org/v2/en/indicator/EG.USE.PCAP.KG.OE?format=json | held-out: reserve one resource-intensity curve family
...
- Replay command: `validation/run_all.py --qa-only (public replay umbrella; domain: SYSTEMS_CIVILIZATIONAL_PROJECTION)`
