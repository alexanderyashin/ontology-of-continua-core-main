# Formal Dossier for HOSTILE::RESIDUE_REBIRTH_BOUNDARY
...
- Exit criterion: Residue, rebirth, and persistence are separated by theorem-backed boundary conditions with declared falsifiers.

## Exact Theorem Route Under Attack

- Source Corollary 3.2
- Lemma 3
- collapse/rebirth classification boundary
...
Refs:
- `releases/oc_core_1_3/editorial/science_sources/hostile_review/hostile_residue_rebirth_boundary.json`
