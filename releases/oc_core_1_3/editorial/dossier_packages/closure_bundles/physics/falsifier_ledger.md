...
- Task id: `TASK::PHYSICS::FALSIFIER_LEDGER`
...
- Declared falsifier: Any benchmark family with residuals outside tolerance or with broken sign/order constraints falsifies the promoted packet.
