...
- Task id: `TASK::MATHEMATICS::THEOREM_PACKET`
...
- Minimum theorem-native claim: Maintain the exact-question theorem-native anchor and expand the counterexample search without broadening scope by rhetoric alone.
...
Maintain the exact-question theorem-native anchor and expand the counterexample search without broadening scope by rhetoric alone.
...
Only the proved subset may carry quantitative outputs for this domain.
...
- `logion/k0/governance/status/OC_OPEN_QUESTION_LINKAGE_latest.json`
- `logion/k0/governance/status/SCIENTIFIC_METHOD_AUTHORITY_latest.json`
