...
- Bundle: `CLOSURE_BUNDLE::METAONTOLOGY`
- Claim: `METAONTOLOGY`
- Phase: `PHASE_1_STABILIZE_CLOSED_CORE`
- Current artifact status: `FRAME_ONLY_COMPLETE`
- Current transition gate: `MAINTENANCE_ONLY`
- Task id: `TASK::METAONTOLOGY::THEOREM_PACKET`
...
- Minimum theorem-native claim: FRAME_ONLY_MONITORING_ONLY
...
- `logion/k0/governance/status/OC_METAONTOLOGY_FRAME_latest.json`
- `logion/k0/governance/status/ESTRA_FORMALISM_EXTENSION_LEDGER_latest.json`
...
- `releases/oc_core_1_3/editorial/science_sources/closure_bundles/metaontology/bundle.json`
