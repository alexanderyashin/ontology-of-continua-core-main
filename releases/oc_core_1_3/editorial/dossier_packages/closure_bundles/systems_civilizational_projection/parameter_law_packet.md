...
- Task id: `TASK::SYSTEMS_CIVILIZATIONAL_PROJECTION::PARAMETER_LAW_PACKET`
...
- Parameter-law target: Explicit systems parameter laws for R_pop, E_tp, and S_regime are locked across the bounded macro-process packet.
...
Evaluate K8 projection laws against pinned official macro-process series with locked held-out interval tests.

## Asymptotics

Trajectory residuals, turning-point error, and regime scores remain bounded under explicit admissible regimes for R_pop, E_tp, and S_regime without discretionary knobs.
