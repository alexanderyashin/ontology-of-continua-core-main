...
- Task id: `TASK::BIOLOGY::FALSIFIER_LEDGER`
...
- Declared falsifier: If the bounded signature family fails on held-out datasets, the biological packet remains frontier-bound.
...
- held_out_signature_failure
- single_dataset_dependence
