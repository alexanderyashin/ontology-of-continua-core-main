...
- Task id: `TASK::BIOLOGY::PARAMETER_LAW_PACKET`
...
- Parameter-law target: Explicit biological parameter laws for A_expr, pi_state, and t_onset are locked across the bounded multi-dataset packet.
...
Choose the declared biological lanes and evaluate theorem-bound state transitions or response signatures against the pinned open assay families.

## Asymptotics

Expression, state-order, and onset residuals remain bounded under explicit admissible regimes for A_expr, pi_state, and t_onset across the locked dataset families.
