...
- Task id: `TASK::BIOLOGY::OBSERVABLE_BINDING_SPEC`
...
- Theorem-to-observable map: K4/K5/K6/K7 organizational thresholds lawfully generate the bounded biology packet over expression, state-transition, and response-onset observable families., The promoted biology packet binds source-native biological organization claims to pinned assay observables without expanding to unrestricted biological universalization., Every promoted biological benchmark family is traced through the locked K4/K5/K6/K7 route, open assay datasets, and held-out replay.
- Observable ids: BIOLOGY::EXPRESSION_SIGNATURE_RESIDUAL, BIOLOGY::STATE_TRANSITION_ORDER_ERROR, BIOLOGY::RESPONSE_ONSET_RESIDUAL
...
- BIOLOGY::EXPRESSION_SIGNATURE_RESIDUAL
- BIOLOGY::STATE_TRANSITION_ORDER_ERROR
- BIOLOGY::RESPONSE_ONSET_RESIDUAL

## Units By Observable

- `BIOLOGY::EXPRESSION_SIGNATURE_RESIDUAL`: normalized assay or timing unit
- `BIOLOGY::RESPONSE_ONSET_RESIDUAL`: normalized assay or timing unit
- `BIOLOGY::STATE_TRANSITION_ORDER_ERROR`: normalized assay or timing unit

## Dataset Field Bindings

- benchmark_id=BIO_BENCH_001, dataset_url=https://www.ncbi.nlm.nih.gov/geo/, held_out_policy=reserve one time-series family for held-out replay, observable_name=expression_signature_residual
- benchmark_id=BIO_BENCH_002, dataset_url=https://www.ncbi.nlm.nih.gov/geo/, held_out_policy=reserve one cell-state transition family, observable_name=state_transition_order_error
- benchmark_id=BIO_BENCH_003, dataset_url=https://www.ncbi.nlm.nih.gov/geo/, held_out_policy=reserve one response-signature family, observable_name=response_onset_residual
...
- `content/k_levels/k5.tex`
- `content/predictions/predictions_k5.tex`
- `content/falsifiability/falsifiability_k5.tex`
- `content/processes/processes_k5.tex`
- `content/experiments/experiments_k5.tex`
- `content/k_levels/k6.tex`
- `content/predictions/predictions_k6.tex`
- `content/falsifiability/falsifiability_k6.tex`
- `content/processes/processes_k6.tex`
- `content/experiments/experiments_k6.tex`
- `content/k_levels/k7.tex`
- `content/predictions/predictions_k7.tex`
- `content/falsifiability/falsifiability_k7.tex`
- `content/processes/processes_k7.tex`
- `content/experiments/experiments_k7.tex`
