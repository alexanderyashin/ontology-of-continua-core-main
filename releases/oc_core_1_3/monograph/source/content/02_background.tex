...
Core~1.3 adopts the unified definition encoded by the operator \(U\):
...
Core~1.3 reserves \(\chi_{\Omega}(s;K,t)\) for pointwise membership of a
...
\subsection{Motivation for Core~1.3}

Core~1.3 consolidates all structural components of OC into a vertically
...
Core~1.3 keeps this chapter deliberately compact: it supplies the background
needed for Section~\ref{sec:model} without duplicating the later proof,
