...
\emph{Ontology of Continua --- Core~1.3} zusammen.
...
\subsection{Zusammenfassung der Beiträge von Core~1.3}

Core~1.3 hat Konsolidierung, Präzisierung, vertikale Konsistenz und eine
...
Core~1.3 dient daher nicht nur als stabile Grundlage, sondern als erste
...
\begin{itemize}
    \item vollständige mathematische Beweise aller in
          Abschnitt~\ref{sec:results} formulierten Theoreme;
...
Core~1.3 stellt das strukturelle Gerüst für diese Bemühungen bereit.
...
Core~1.3 stellt dieses Programm als kohärente Axiomatik, eine universelle
...
bauen auf dieser Grundlage auf. Core~1.3 ist für seinen vorgesehenen Umfang
