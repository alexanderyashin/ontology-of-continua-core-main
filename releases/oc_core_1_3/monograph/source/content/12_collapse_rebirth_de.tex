...
increasingly narrow margins. At the threshold, any fürther perturbation
...
\begin{itemize}
  \item cognitive collapse (loss of coherent internal models) may be followed
        by reconstruction of new models using überlebenden representations as
...
\end{itemize}
Subsequent emergence of new theories or meta-frameworks built on überlebenden
