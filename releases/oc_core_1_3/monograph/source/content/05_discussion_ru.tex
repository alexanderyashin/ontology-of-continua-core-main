...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/05_discussion.tex
...
No new axioms or теоремуs are introduced here; the goal is to clarify the meaning of the existing formalism 
...
\begin{itemize}
    \item full, self–contained proofs of the теоремуs stated in Section~\ref{sec:results}, with explicit assumptions and intermediate lemmas;
...
It provides a coherent, minimal and extensible foundation on which more detailed, domain–specific developments can be built in subsequent Core and extension работуs.
