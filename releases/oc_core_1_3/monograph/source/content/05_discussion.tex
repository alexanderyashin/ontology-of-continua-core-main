...
Sections~\ref{sec:model}–\ref{sec:results}. It explains what the Ontology of
...
The measure \(k(K,t)\) integrates information about the richness of \(\Omega(K)\), the presence and stability of cycles, the expressive adequacy of axes, and the compatibility of those axes with the active thresholds.
