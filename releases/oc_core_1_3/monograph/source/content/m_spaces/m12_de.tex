...
Dies macht $M_{12}$ zur Terminalumgebung für Core~1.3.
...
\begin{itemize}
    \item $A_{\mathrm{universal}}$ – Variation über ganze Universen von Metahierarchien,
...
\begin{itemize}
    \item $U_{\mathrm{universal}}$ – Potenzial zur Unterstützung ganzer Universen von Metahierarchien,
...
\begin{itemize}
    ...
    \item $\Theta_{12}^{\mathrm{universal}}$ – minimale universelle Kompatibilität,
...
\begin{itemize}
    \item $J_{\mathrm{universal}}$ – Flüsse, die Universen von Metahierarchien neu organisieren,
...
\begin{itemize}
    \item $C_{\mathrm{universal}}$ — Erzeugung und Stabilisierung von Universen von Metahierarchien,
