...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/13_branching_topology.tex
% ====================================================================
...
\begin{enumerate}
  ...
  \item the branch cannot be extended fürther while respecting the axioms
...
\begin{itemize}
  ...
  \item \textbf{Asymptotic thinning.}\quad
        ...
        (\(k_{x_i}\to 0\) as \(i\to\infty\)) and cannot support fürther
