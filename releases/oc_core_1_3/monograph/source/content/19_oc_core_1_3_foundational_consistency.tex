...
\item \textbf{Empirical statements} require a standalone source-owned domain
      ...
      parameter packet, locked held-out replay procedure, comparator audit,
...
the canonical SPOT scientific-class and closure-class vocabulary. Release
verdicts such as \texttt{PASS} and \texttt{FAIL\_CLOSED} remain a separate
closure layer. The mapping is:
\begin{itemize}
...
the statement class and numerical parameter packet have already been fixed
