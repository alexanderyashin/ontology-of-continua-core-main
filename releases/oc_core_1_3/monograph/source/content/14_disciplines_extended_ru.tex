...
Each domain-specific mapping is a representation теорему: a demonstration that
...
\paragraph{Representation theorem: Physics to K2.}
...
% ====================================================================
\subsection{Chemistry and Origins of Life (Levels K3-K4)}
% ====================================================================

Chemical systems instantiate \(K_3\), while protocellular systems instantiate
\(K_4\).

\paragraph{Chemical continua (K3).}
\begin{itemize}
...
\paragraph{Protocellular continua (K4).}
\begin{itemize}
...
\paragraph{Representation theorem: Chemistry and protocells to K3/K4.}
...
% ====================================================================
\subsection{Biology (Levels K4-K5)}
% ====================================================================
...
\paragraph{Representation theorem: Biology to K5.}
...
\paragraph{Representation theorem: Cognition to K6.}
...
\paragraph{Representation theorem: Society to K7.}
...
% ====================================================================
\subsection{Civilisation (Level K8)}
% ====================================================================
...
\[
\begin{aligned}
  P_8 &: \text{energy availability, resource gradients, risk potentials},\\
...
\paragraph{Representation theorem: Civilisation to K8.}
...
% ====================================================================
\subsection{Theory and Meta-Theory (Levels K9-K10)}
% ====================================================================

Theoretical and meta-theoretical structures instantiate the highest levels.

\medskip\noindent\textbf{Theoretical continua (K9).}
\begin{itemize}
...
\medskip\noindent\textbf{Meta-theoretical continua (K10).}
\begin{itemize}
...
\paragraph{Representation theorem: Theory to K9, Meta-Theory to K10.}
...
subsequent quantitative extension work within and beyond Core~1.3.
