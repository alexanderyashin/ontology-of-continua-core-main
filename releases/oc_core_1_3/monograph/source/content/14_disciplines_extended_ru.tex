...
\paragraph{Representation теорему (Physics → \texorpdfstring{\(K_2\)}{K_2}).}
...
\paragraph{Representation теорему (Chemistry/Protocells → \texorpdfstring{\(K_3\)}{K_3}/\texorpdfstring{\(K_4\)}{K_4}).}
...
\paragraph{Representation теорему (Biology → \texorpdfstring{\(K_5\)}{K_5}).}
...
\paragraph{Representation теорему (Cognition → \texorpdfstring{\(K_6\)}{K_6}).}
...
\paragraph{Representation теорему (Society → \texorpdfstring{\(K_7\)}{K_7}).}
...
\paragraph{Representation теорему (Civilisation → \texorpdfstring{\(K_8\)}{K_8}).}
...
\paragraph{Representation теорему (Theory → \texorpdfstring{\(K_9\)}{K_9}, Meta-Theory → \(K_{10}\)).}
