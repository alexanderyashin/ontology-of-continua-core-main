...
Core 1.3.3 states the continuum carrier separately from live realizations, replaces global \(K_0\)
...
hybrid update components rather than universal derivatives.  The published tuple
\[
...
is empty, so death, residue, and rebirth have distinct typed status.
