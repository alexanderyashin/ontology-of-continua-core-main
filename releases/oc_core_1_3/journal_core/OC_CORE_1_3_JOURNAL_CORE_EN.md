...
Theorem A therefore proves the source death-and-residue route. Proposition B records the article-local related-space witness branch. It does not claim that every source-admissible related-space rebirth is covered by the map-and-witness clause; cases without that witness remain outside this article's promoted rebirth branch.
...
| projection and utility atlases | [Unified synthesis support dossiers](../monograph/source/appendix/Q_oc_core_1_3_toe_support_dossiers.tex); [Practical utility and model-comparison atlas](../monograph/source/appendix/R_oc_core_1_3_practical_utility_model_comparison_atlas.tex); [practical-utility atlas JSON](../editorial/OC_CORE_1_3_PRACTICAL_UTILITY_ATLAS_latest.json) |
...
- Proposition B (article-local related-space rebirth control): the parallel rebirth-control branch for later qualifying continua.
