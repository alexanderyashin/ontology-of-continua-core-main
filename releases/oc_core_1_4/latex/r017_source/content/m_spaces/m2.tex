...
\subsubsection{\texorpdfstring{$M_2$}{M_2} Overview}
...
\subsubsection*{1. Structure of \texorpdfstring{$\Omega(M_2)$}{\Omega(M_2)}}
...
\subsubsection*{2. Admissible Axes in \texorpdfstring{$M_2$}{M_2}}
...
\subsubsection*{5. Admissible Flows and Propagation}
...
\subsubsection*{6. Quantization Thresholds and Minimal Clusters}
...
\subsubsection*{7. Collapse and Boundary of \texorpdfstring{$M_2$}{M_2}}
...
\subsubsection*{8. Relation to \texorpdfstring{$K_1$}{K_1} and \texorpdfstring{$K_3$}{K_3}}
