...
\subsubsection{\texorpdfstring{$M_6$}{M_6} Overview}
...
% ---------------------------------------------------------------
\subsubsection*{1. Admissible Configuration Space \texorpdfstring{$\Omega(M_6)$}{\Omega(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{2. Admissible Axes \texorpdfstring{$A(M_6)$}{A(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{3. Potentials \texorpdfstring{$P(M_6)$}{P(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{4. Thresholds \texorpdfstring{$\Theta(M_6)$}{\Theta(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{5. Flows \texorpdfstring{$J(M_6)$}{J(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{6. Cycles \texorpdfstring{$C(M_6)$}{C(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{7. Boundary \texorpdfstring{$\partial\Omega(M_6)$}{\partial\Omega(M_6)}}
...
% ---------------------------------------------------------------
\subsubsection*{8. Relation to \texorpdfstring{$M_5$}{M_5} and \texorpdfstring{$M_7$}{M_7}}
