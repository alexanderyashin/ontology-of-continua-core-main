...
% This file collects all cross-K linking sections.
...
\begin{enumerate}
  ...
  \item satisfies the general compatibility rule:
        ...
        \]
        while preserving continuity and allowing valid transitions under
        the global operator $E$.
\end{enumerate}
...
This master module intentionally remains a \textbf{thin integration layer}.  
...
\noindent The following files are assembled by this module:
\begin{itemize}
