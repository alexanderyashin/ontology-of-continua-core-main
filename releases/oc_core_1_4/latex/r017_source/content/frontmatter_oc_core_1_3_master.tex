...
{\sffamily\Huge\bfseries Core~1.4}\\[0.28cm]
...
{\normalsize Version v1.4}\\[0.3cm]
{\normalsize Manuscript revision date: 2026-05-08}\\[0.3cm]
...
OC Core~1.4 is the bounded external-review release of that model core. It
...
sheet, formalization reference, finite semantic case, replay row, comparator row, or
...
validation before they widen the public claim surface. Version~1.4 therefore
...
\clearpage
\section*{Version 1.4 Release Delta}
\phantomsection
\addcontentsline{toc}{section}{Version 1.4 Release Delta}
...
unpublished working material. No unpublished working note or non-public editorial
record is promoted as reader-facing evidence merely because it
helped produce the release.

Version~1.4 is the release in which the OC Core corpus is reorganized from
...
The verification delta adds and consolidates a Lean-oriented formalization inventory, structured
proof sheets, finite semantic checks, finite witness interpretation, bounded
retrospective bounded replay QA, comparator and prior-art positioning, negative-control
...
For a returning reader, the practical point is this: 1.4 should be read as a
...
all ask legitimate questions of the same manuscript. OC Core~1.4 is therefore
...
in Part~III, the theorem/proof route, the Lean-oriented formalization inventory, finite semantic
...
evidence chapters, retrospective bounded replay QA, numeric tables, machine-readable
