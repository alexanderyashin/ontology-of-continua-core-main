...
This appendix collects the illustrative TikZ figures used in the Core~1.3
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/continua_structure}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/axes_thresholds}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/thresholds_taxonomy}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/delta_threshold_k0}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/k0_to_k1_transition}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/levels_hierarchy}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/potential_landscape}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/evolution_operator}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/birth_life_death}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/percolation_diagram}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/bkt_transition}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/qubit_bloch_sphere}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/raf_network}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/catalytic_paths}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/membrane_closure}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/gradient_osmosis_tension}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/vesicle_flickering}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/dv_propagation_membrane}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/ion_channel_states}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/proto_spike}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/cognitive_state_space}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/binding_space}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/institutional_cycles}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/trust_threshold}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/civilization_energy_cycles}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/technological_layers_m8}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/theory_graph}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/representation_flow_graph}
...
\begin{figure}[p]
  \centering
  \input{public_payload/latex/r017_source/figures/metatheory_k10_selfreference}
