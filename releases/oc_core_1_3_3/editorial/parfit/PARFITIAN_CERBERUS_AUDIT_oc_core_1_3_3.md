# Parfitian Cerberus Audit: oc_core_1_3_3
...
- Affected refs: releases/oc_core_1_3_3/editorial/parfit/relation_r_manifest.yaml
...
- Blocking: `true`
- Summary: Release-critical mode fails closed when Parfitian moral-mathematics inputs are absent.
- Affected refs: releases/oc_core_1_3_3/editorial/parfit/future_stakeholder_manifest.yaml
...
- Blocking: `true`
- Summary: Release-critical mode fails closed when Parfitian moral-mathematics inputs are absent.
- Affected refs: releases/oc_core_1_3_3/editorial/parfit/five_part_decision_matrix.yaml
...
- Blocking: `true`
- Summary: Release-critical mode fails closed when Parfitian moral-mathematics inputs are absent.
- Affected refs: releases/oc_core_1_3_3/editorial/parfit/repugnant_output_assessment.yaml
