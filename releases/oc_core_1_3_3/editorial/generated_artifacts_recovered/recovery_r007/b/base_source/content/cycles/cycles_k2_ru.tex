...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/cycles/cycles_k2.tex
% ================================================================
...
\subsubsection{Definition of Cycles on \texorpdfstring{$K_2$}{K_2}}
...
\subsubsection{Types of Cycles on \texorpdfstring{$K_2$}{K_2}}
...
\subsubsection{Structural Tension and Threshold Interaction}
...
\subsubsection{Metrics of Cycles on \texorpdfstring{$K_2$}{K_2}}

Consistent with the corresponding construction route, cycles are measured via:
...
\subsubsection{Birth of Time and Non-Trivial Cycles}
...
\subsubsection{Role of \texorpdfstring{$K_2$}{K_2} Cycles in the Hierarchy}
