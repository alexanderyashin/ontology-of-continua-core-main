...
\item an explicit contradiction of a promoted claim first flags a
      refutation-candidate or surface-contradiction case for science-state register audit;
...
\item pure structural or interpretive content keeps the science-state register-recorded
...
\item bridge-only support row is a stable evidence-support class for rows or
      ...
      bounded theorem-route support queue.
\end{enumerate}
...
the internal science-state register scientific-class and closure-verdict vocabulary. Release
verdicts such as \texttt{bounded evidence recorded} and \texttt{repair-required boundary} remain a separate
verdict layer. The mapping is:
\begin{itemize}
\item Axiomatic statements are admitted premises or identity rules. They may
      sit inside a bounded theorem route route as named assumptions, but
      the axiom itself is not thereby converted into a proved theorem.
\item Derived statements map to bounded theorem route when the support
      route is closed.
\item Empirical statements map to bounded theorem route only after the
...
\item Structural and interpretive statements map to support-only row or
      future-work support row as recorded by science-state register unless the statement is attached
...
\item Fail-closed bridge, frame, or extension lanes retain the class recorded
      by science-state register; closure failure by itself is not refutation.
\item Statements map to negative-control rejection row only when science-state register records an explicit
...
may be \texttt{bounded evidence recorded} as frame support, but they do not become standalone
...
proof-routed \texttt{bounded evidence recorded} rows unless a separate source-owned
proof-routed packet is created and passes the canonical gates. \texttt{frontier extension row} and
\texttt{negative-control rejection row} lanes remain outside public \texttt{bounded evidence recorded} authority.
