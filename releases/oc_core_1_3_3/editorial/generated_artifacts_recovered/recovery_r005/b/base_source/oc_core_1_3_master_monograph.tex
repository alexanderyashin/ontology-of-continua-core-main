...
\input{content/28e_oc133_inline_figures_reader_routes.tex}
...
\appendix
\ocvolumeblock{Scientific Evidence and Review Appendices}{The appendices preserve notation, axioms, K-level tables, provenance, journal extraction logic, reviewer objections, empirical replay surfaces, benchmark cases, proof machinery, technical derivations, synthesis support, and applied comparison material. They are secondary scientific annexes: the main body remains the teaching path, while this framed block prevents loss of corpus content and gives reviewers the evidence map needed to audit the release. Figures are distributed inline in the manuscript rather than collected as a detached atlas.}
...
\medskip
\noindent\textbf{Citation identity.} Alexander Yashin, \emph{Ontology of Continua Core 1.3.3: Master Monograph}, revision recovery\_r005, 3 May 2026. The Concept DOI is printed on the title page.
