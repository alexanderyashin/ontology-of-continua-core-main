...
\vspace{1.2em}
{\Large Methods, validation, reproducibility, and replay companion\par}
\vspace{2.5em}
...
Citation identity: Alexander Yashin, OC Core Methods and Reproducibility Companion v1.3.3, revision recovery_r005, 3 May 2026. The Concept DOI is printed on the title page.
