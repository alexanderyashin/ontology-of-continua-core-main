...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/predictions/predictions_k6.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{P1: Predictions Concerning the Birth of Cognition}
...
% ---------------------------------------------------------------
\subsubsection{P2: Predictions from the S-module (Meaning Formation)}
...
% ---------------------------------------------------------------
\subsubsection{P3: Predictions Concerning Attractors and Pattern Dynamics}
...
% ---------------------------------------------------------------
\subsubsection{P4: Predictions Concerning Comparison, Similarity and Distance}
...
% ---------------------------------------------------------------
\subsubsection{P5: Predictions Concerning Structural Tension and Contradiction}
...
% ---------------------------------------------------------------
\subsubsection{P6: Predictions Concerning Memory and Stability}
...
% ---------------------------------------------------------------
\subsubsection{P7: Predictions Concerning Information Flow and Computation}
...
\]
a biologically scoped constraint.

% ---------------------------------------------------------------
\subsubsection{P8: Predictions Concerning Collapse and Transitions}
...
\paragraph{(P6.29) Transition to \texorpdfstring{$K_7$}{K_7} (Social Continuum).}
$K_6$ predicts:
\[
