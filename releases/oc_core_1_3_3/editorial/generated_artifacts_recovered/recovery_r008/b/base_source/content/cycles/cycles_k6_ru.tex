...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/cycles/cycles_k6.tex
% ================================================================
% ==== FILE: content/cycles/cycles_k6.tex
% ================================================================

\subsubsection{Cycles on \texorpdfstring{$K_6$}{K_6}}
\label{sec:cycles-k6}
...
\subsubsection{Overview of Cognition-Level Cycles}
...
\subsubsection{1. Predictive-Processing Cycle $C_{\mathrm{PE}}$}
...
\subsubsection{2. Binding Cycle $C_{\mathrm{bind}}$}
...
\subsubsection{3. Attention–Salience Cycle $C_{\mathrm{attn}}$}
...
\subsubsection{4. Working-Memory Cycle $C_{\mathrm{wm}}$}
...
\subsubsection{5. Conceptual Cycle $C_{\mathrm{concept}}$}
...
\subsubsection{6. Cognitive Rhythm Cycle $C_{\mathrm{cog\text{-}rhythm}}$}
...
\subsubsection{7. Multi-Scale Integration Cycle $C_{\mathrm{integrate}}$}
...
\subsubsection{8. Meta-Cognitive Cycle $C_{\mathrm{meta}}$}
...
\subsubsection{Metrics of Cognitive Cycles}
...
\subsubsection{Collapse of \texorpdfstring{$K_6$}{K_6} Cycles}
...
\subsubsection{Continuity from \texorpdfstring{$K_5$}{K_5} to \texorpdfstring{$K_6$}{K_6}}
...
This is a dimensional transition governed by scoped conditions:
\[
  T > \Theta_{\mathrm{dim}}.
\]
