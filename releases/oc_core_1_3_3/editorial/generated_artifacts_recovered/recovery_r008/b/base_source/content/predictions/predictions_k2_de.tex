...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/predictions/predictions_k2.tex
% ================================================================
...
dynamics induced by the scoped evolution operator $U$.

The predictions fall into six major groups.

% ---------------------------------------------------------------
\subsubsection{P1: Predictions Concerning Axes and Geometry}
...
% ---------------------------------------------------------------
\subsubsection{P2: Predictions Concerning Percolation and Connectivity}
...
\paragraph{(P3.2) Diffusion as a scoped Process.}
The scoped form of $K_2$ dynamics predicts:
\[
...
% ---------------------------------------------------------------
\subsubsection{P5: Predictions Concerning Boundary, Collapse and Phase Transitions}
