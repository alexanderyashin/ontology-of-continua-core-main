...
\vspace{2.5em}
{\large\textbf{Artifact role:} Compact article-style scientific argument\par}
\vspace{2.5em}
...
\vspace{1.5em}
{\small Citation identity: Alexander Yashin, OC Core Journal Core Article v1.3.3, version 1.3.3, 10.5281/zenodo.17899134.\par}
\vspace{1.2em}
