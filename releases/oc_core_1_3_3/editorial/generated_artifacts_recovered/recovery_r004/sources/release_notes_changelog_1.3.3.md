---
document_title: "OC Core Release Notes and Changelog v1.3.3"
...
{\Huge\bfseries OC Core Release Notes and Changelog v1.3.3\par}
\vspace{1.2em}
{\Large Ontology of Continua Core release review artifact\par}
\vspace{2.5em}
{\large\textbf{Artifact role:} Release notes and change log\par}
\vspace{2.5em}
...
\vspace{1.5em}
{\small Citation identity: Alexander Yashin, OC Core Release Notes and Changelog v1.3.3, version 1.3.3, 10.5281/zenodo.17899134.\par}
\vspace{1.2em}
...
# Reader Orientation and Claim Boundaries
...
## Release Scope vs Full Science Program
...
## Claim Promotion, Demotion, and Background Obligations
