...
% Erweiterte Rand- und Patch-Geometrie — Core 1.3.3 (Abschlussversion)
% ====================================================================
...
\(K_6\)--\(K_8\).
Die vorliegende Version konsolidiert die für Core~1.3.3 erforderliche vollständige Struktur:
