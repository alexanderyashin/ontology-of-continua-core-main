...
\subsubsection{Fundamental Types of Cycles on \texorpdfstring{$K_3$}{K_3}}
...
\subsubsection{Metrics of Cycles on \texorpdfstring{$K_3$}{K_3}}

Consistent with the scoped metrics (the corresponding construction route):
...
\subsubsection{Time and Cycle Periods}
...
\subsubsection{Birth of Higher-Level Cycles}
...
Biological cycles (metabolic, membrane, excitability) emerge only later
from that basis.
