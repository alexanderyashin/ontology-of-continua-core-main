...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: appendix/B_axioms_full.tex
% ====================================================================
...
Core~1.3.3.  It is not a replacement for the detailed exposition in
the formal model chapter, but it provides a concise reference.
...
\paragraph{Axiom 0.2 (Nontrivial threshold \texorpdfstring{\(\Theta_0\)}{\Theta_0}).}
...
extension Artikels (for example, detailed forms of structural tension, specific
