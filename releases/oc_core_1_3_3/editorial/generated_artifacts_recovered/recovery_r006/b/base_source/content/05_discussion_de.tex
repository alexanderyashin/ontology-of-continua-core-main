...
Dieser Abschnitt interpretiert das in the formal model chapter section results vorgestellte
...
Die Ergebnisse in the historical result-boundary chapter formulieren mehrere zentrale Festlegungen des
OC-Rahmens.
...
\begin{enumerate}
    \item Es übernimmt die allgemeine Kontinuumsstruktur aus the formal model chapter;
...
\begin{itemize}
    \item vollständige, in sich geschlossene Beweise der Sätze aus
          the historical result-boundary chapter, mit expliziten Annahmen und Zwischenbeweisen;
...
Core~1.3.3 beansprucht nicht, jede zukünftige Forschungsrichtung zu lösen. Es
