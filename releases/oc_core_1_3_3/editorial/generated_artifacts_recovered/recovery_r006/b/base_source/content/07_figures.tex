...
This appendix collects the illustrative TikZ figures used in the Core~1.3.3
...
\begin{figure}[p]
  ...
  \caption{vertical hierarchy of continua from \texorpdfstring{\(K_0\)}{K_0} to \texorpdfstring{\(K_{12}\)}{K12}.}
