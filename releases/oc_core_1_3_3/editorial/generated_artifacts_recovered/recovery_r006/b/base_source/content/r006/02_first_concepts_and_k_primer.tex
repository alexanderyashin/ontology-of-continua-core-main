...
\label{sec:r006-first-concepts-k-primer}
...
\begin{tikzpicture}[scale=0.88, every node/.style={font=\small}]
  ...
  \foreach \r/\lab in {0.9/{service or cell},1.65/{team or tissue},2.45/{enterprise or organism},3.25/{market or ecology}} {
    \draw[ocBlue, line width=0.8pt] (0,0) circle (\r);
    \node[align=center] at (0,\r-0.34) {\lab};
  }
  \draw[->, thick, ocGold] (-3.6,-3.2) -- (3.6,3.2) node[above right] {higher K-level constraints};
  \draw[->, thick, ocGold] (3.4,-3.1) -- (-3.35,3.05) node[above left] {lower continua compose};
  \node[align=center] at (0,-3.75) {K-levels form nested continua, not a single flat taxonomy.};
\end{tikzpicture}
\caption{Nested K-level intuition. Lower continua compose higher continua, while higher continua constrain the space of possible lower-level behavior. This is why OC treats K-levels as a connected system of systems rather than a loose classification.}
\label{fig:r006-nested-k-levels}
\end{figure}
