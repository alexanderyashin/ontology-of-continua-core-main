...
- `PASS` `machine_self_audit_status`: baseline=`None` candidate=`PASS`
- `PASS` `filter_regression_status`: baseline=`None` candidate=`PASS`
- `PASS` `reviewer_routing_status`: baseline=`None` candidate=`PASS`
- `PASS` `cockpit_observability_status`: baseline=`None` candidate=`PASS`
- `PASS` `artifact_precision_status`: baseline=`None` candidate=`PASS`
- `PASS` `journal_projection_consistency_status`: baseline=`None` candidate=`PASS`
- `PASS` `zenodo_readiness_assessment_status`: baseline=`None` candidate=`PASS`
- `PASS` `toe_gap_assessment_status`: baseline=`None` candidate=`PASS`
- `PASS` `r017_final_gate_status`: baseline=`None` candidate=`PASS`
