...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k0
% ================================================================
% ==== FILE: content/experiments/experiments_k0
% ================================================================
...
in the usual sense.
Instead, the protocol review of $K_0$ proceeds through \emph{structural} and
...
\begin{enumerate}
    ...
    \item \textbf{Well–posedness of $\Psi_{0\to 1}$.}
          ...
          \]
          in full agreement with the formal definition tested in
          Core~1.3.3.
\end{enumerate}
...
\begin{itemize}
    ...
    \item support that no structure of dimension $\ge 1$ is forced at $K_0$;
    \item syntactic and semantic protocol review of the proto–parameter axioms;
...
These Experiments probe the minimal domain $S$ from which the
