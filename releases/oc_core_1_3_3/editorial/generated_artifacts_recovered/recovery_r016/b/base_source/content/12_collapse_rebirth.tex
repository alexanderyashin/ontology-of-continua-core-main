...
the historical result-boundary chapter into explicit criteria, dynamical signatures and
...
general framework of the formal model chapter, the structural results of
the historical result-boundary chapter, the extended treatment of boundaries in
the boundary geometry chapter, the threshold landscape in
the threshold landscape chapter, the full hierarchy of levels in
the K-level witness taxonomy chapter, and the operator family in
...
Theorem~3 and Theorem~9 of the historical result-boundary chapter.
...
Corollary~3.1 in the historical result-boundary chapter can be restated as:
...
(the boundary geometry chapter) provides a more granular picture.
...
\((\Omega,\partial\Omega,A,\Theta,P,J,C,k,M)\). They may, however, form the
substrate for new continua.

\paragraph{Limits of recovery.}
Because death is structurally irreversible
(Theorem~3 and Corollary~3.2 in the historical result-boundary chapter), no operator acting
...
birth, evolution and death of continua across the hierarchy K0--K12.
