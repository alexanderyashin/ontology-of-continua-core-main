...
\begin{enumerate}
    ...
    \item describe characteristic collapse modes and link them to known
          physical, chemical, biological or social criticism routes.
\end{enumerate}
...
and documented in the appendix on appendix full scope synthesis constants and parameters.
...
\input{content/toe/toe_k0_ru.tex}
\input{content/toe/toe_k1_ru.tex}
\input{content/toe/toe_k2_ru.tex}
\input{content/toe/toe_k3_ru.tex}
\input{content/toe/toe_k4_ru.tex}
\input{content/toe/toe_k5_ru.tex}
\input{content/toe/toe_k6_ru.tex}
\input{content/toe/toe_k7_ru.tex}
\input{content/toe/toe_k8_ru.tex}
\input{content/toe/toe_k9_ru.tex}
\input{content/toe/toe_k10_ru.tex}
\input{content/toe/toe_k11_ru.tex}
\input{content/toe/toe_k12_ru.tex}
