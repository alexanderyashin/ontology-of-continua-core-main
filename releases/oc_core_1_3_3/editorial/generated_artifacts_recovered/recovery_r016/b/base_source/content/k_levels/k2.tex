...
\subsubsection{\texorpdfstring{$K_2$}{K_2} Overview}
...
% ================================================================
\subsubsection{State Space \texorpdfstring{$\Omega(K_2)$}{\Omega(K_2)}}
...
% ================================================================
\subsubsection{Boundary \texorpdfstring{$\partial\Omega(K_2)$}{\partial\Omega(K_2)}}
...
% ================================================================
\subsubsection{Axes \texorpdfstring{$A(K_2)$}{A(K_2)}}
...
% ================================================================
\subsubsection{Potentials \texorpdfstring{$P(K_2)$}{P(K_2)}}
...
% ================================================================
\subsubsection{Thresholds \texorpdfstring{$\Theta(K_2)$}{\Theta(K_2)}}
...
% ================================================================
\subsubsection{Flows \texorpdfstring{$J(K_2)$}{J(K_2)}}
...
% ================================================================
\subsubsection{Cycles \texorpdfstring{$C(K_2)$}{C(K_2)}}
...
in the historical BKT construction route, pending a current proof-sheet binding:
\begin{itemize}
...
% ================================================================
\subsubsection{Time \texorpdfstring{$\tau(K_2)$}{\tau(K_2)}}

Time emerges for the first time at $K_2$.

From the historical time-emergence construction route, pending a current proof-sheet binding:
\[
...
% ================================================================
\subsubsection{Continuumness \texorpdfstring{$k(K_2)$}{k(K_2)}}
...
% ================================================================
\subsubsection{Structural Tension \texorpdfstring{$T(K_2)$}{T(K_2)}}
...
% ================================================================
\subsubsection{Energy \texorpdfstring{$E(K_2)$}{E(K_2)}}
...
% ================================================================
\subsubsection{Operators on \texorpdfstring{$K_2$}{K_2} (\texorpdfstring{$\Psi$}{\Psi}, \texorpdfstring{$\Phi$}{\Phi}, \texorpdfstring{$\Lambda$}{\Lambda}, \texorpdfstring{$U$}{U}, \texorpdfstring{$\Chi$}{\Chi})}
...
% ================================================================
\subsubsection{Processes on \texorpdfstring{$K_2$}{K_2}}
...
% ================================================================
\subsubsection{Predictions for \texorpdfstring{$K_2$}{K_2}}
...
\begin{enumerate}
    ...
    \item scoped power-law correlations below $K_c$.
...
% ================================================================
\subsubsection{Experiments for \texorpdfstring{$K_2$}{K_2}}
...
\begin{itemize}
    ...
    \item scoped jump in stiffness at the BKT transition.
\end{itemize}
...
% ================================================================
\subsubsection{Collapse and Death of \texorpdfstring{$K_2$}{K_2}}
...
% ================================================================
\subsubsection{Branching / Ontological Position of \texorpdfstring{$K_2$}{K_2}}
