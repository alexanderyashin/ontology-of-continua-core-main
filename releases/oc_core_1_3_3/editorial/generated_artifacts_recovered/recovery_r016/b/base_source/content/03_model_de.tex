...
Abschnitt~the operator semantics chapter entwickelt wird, überführt \(k(K,t)\) auf
...
benötigt zusätzlich die in Abschnitt~the lifecycle and rebirth chapter genannten Klauseln
...
Abschnitt~the spontaneous-dimension theorem discussion dokumentiert.
