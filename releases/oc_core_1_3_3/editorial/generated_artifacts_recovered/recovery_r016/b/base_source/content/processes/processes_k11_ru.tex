...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/processes/processes_k11.tex
% ================================================================
...
\begin{itemize}
    ...
    \item emergence of meta-cycles and declared structural constraints.
\end{itemize}
...
\begin{itemize}
    ...
    \item identification of scoped schemas across systems,
...
\begin{itemize}
    ...
    \item identification of scoped constructions.
\end{itemize}
...
(\Theta^{11}_{\text{meta-consistency}},
 ...
 \Theta^{11}_{\text{scoped-validity}}).
\]
...
% ---------------------------------------------------------------
\subsubsection{Meta-Cycles: scoped generality, Extension, Collapse}
...
\begin{itemize}
    \item \textbf{scoped generality cycle}
      — identification of scoped patterns, logics, and structures.
...
\[
P^{11}_{\text{scoped generality}} \uparrow,\quad
...
\begin{itemize}
    \item synthesis of meta-architectures into general operators,
...
\]
creates a scoped meta-space where architectural constraints
...
\begin{itemize}
    ...
    \item scoped, extension, stability, and collapse meta-cycles,
    \item emergence of declared model structures leading to $K_{12}$.
\end{itemize}
