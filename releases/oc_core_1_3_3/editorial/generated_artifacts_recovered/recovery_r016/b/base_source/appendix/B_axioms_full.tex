...
% Core 1.3.3 — Axiomatics (compact collected form)
% ====================================================================

\section{Appendix B -- Collected Axiomatics}
...
Core~1.3.3. It does not replace the detailed exposition in
the formal model chapter; it serves as a compact reference map for the
...
the operator semantics chapter.  \(E\) is defined only while
\(\Omega(K)\neq\emptyset\).
...
The axioms listed here represent the subset of the full archival source corpus axiomatics
that is required for Core~1.3.3. Additional technical axioms introduced in
