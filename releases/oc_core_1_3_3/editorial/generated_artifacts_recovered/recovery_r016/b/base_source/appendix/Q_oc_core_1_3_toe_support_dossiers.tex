...
\subsection{K-level synthesis evidence summary}

The full synthesis support route is represented here as a reviewer-facing evidence summary. The machine-readable checksum remains in the evidence package; this text explains how a reviewer should use the record without turning the monograph into a generated dossier.
