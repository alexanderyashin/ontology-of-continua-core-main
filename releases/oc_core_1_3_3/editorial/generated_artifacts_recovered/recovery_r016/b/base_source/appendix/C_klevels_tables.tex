...
\section{Appendix C -- K-Level Tables and Structural Conditions}
...
\begin{octablescope}
\begin{longtable}{@{}L{0.08\textwidth}L{0.18\textwidth}L{0.58\textwidth}@{}}
\caption{Continuum hierarchy from K0 to K12 with level, domain, and structural characterization columns.}\label{tab:klevels-overview}\\
\toprule
...
% R013_TABLE_LAYOUT_STANDARD: normalized from float/tabular to reader-safe longtable.
\begin{octablescope}
\begin{longtable}{@{}L{0.08\textwidth}L{0.18\textwidth}L{0.22\textwidth}L{0.42\textwidth}@{}}
\caption{Structural components per K-level: axes, potentials, and typical cycles used as the reader-facing audit surface.}\label{tab:klevels-structure}\\
\toprule
...
\begin{itemize}
  ...
  \item Axis growth is treated as a witness obligation:
