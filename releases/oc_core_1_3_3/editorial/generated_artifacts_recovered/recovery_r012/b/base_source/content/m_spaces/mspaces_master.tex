...
M-spaces have three scoped functions:
...
\begin{enumerate}
    ...
    such as $\Psi$, $\Phi$, $\Lambda$, $U$, and $\Chi$, and ensures that
    continua obey the scoped laws of evolution, collapse, and branching.
\end{enumerate}
