...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/processes/processes_k9.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{Concept Formation and Semantic Stabilisation}
...
% ---------------------------------------------------------------
\subsubsection{Model Building and Theorisation Processes}
...
% ---------------------------------------------------------------
\subsubsection{Inference, Deduction, and Proof Processes}
...
% ---------------------------------------------------------------
\subsubsection{Paradigm Formation and Shift Cycles}
...
% ---------------------------------------------------------------
\subsubsection{Abstraction, Generalisation, and Compression Processes}

$K_9$ systems compress lower-level structures ($K_6$–$K_8$) into:
\begin{itemize}
    \item laws,
    \item scoped relations,
...
% ---------------------------------------------------------------
\subsubsection{Cross-Theory Fusion and Integration Processes}
...
% ---------------------------------------------------------------
\subsubsection{Formalisation and Mathematisation}
...
% ---------------------------------------------------------------
\subsubsection{Epistemic Governance, Methodology, and Scientific Cycles}
...
% ---------------------------------------------------------------
\subsubsection{Internal Collapse, Degeneration, and Paradigm Death}
...
% ---------------------------------------------------------------
\subsubsection{Meta-Processes and Emergence of $K_{10}$}
