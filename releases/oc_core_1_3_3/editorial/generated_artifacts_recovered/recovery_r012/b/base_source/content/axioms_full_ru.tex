...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/axioms_full.tex
% ============================
% content/axioms_full.tex
% ============================
\section{Historical Core 1.2 Provenance: Complete Axiomatic System (Non-Promoted Baseline)}
...
There exists a meta-domain \(M\) providing the ambient space of possible states for declared continuum classes \(K\).
...
\[
  \boldsymbol{\tau}(K)=\{\tau_{\mathrm{life}},\tau_{\mathrm{regen}},
  \tau_{\mathrm{response}},\tau_{\mathrm{cycle}},
  \tau_{\mathrm{collapse}},\dots\},
\]
governing reactivity, cycle closures, and collapse dynamics. Scalar level-time
displays \(\tau(K_x)\) are effective-time aliases derived from this temporal
parameter family.
...
The derivative \(dk/dt\) is governed by the scoped operator \(U\) depending on \(\Omega,\partial\Omega,A,P,\Theta,J,C\).
