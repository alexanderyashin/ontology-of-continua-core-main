# PLOS Computational Biology Manuscript Projection
...
- Venue focus: computational-biology package with author summary, data/code openness, and methods reproducibility.
