...
\subsubsection{\texorpdfstring{$K_1$}{K_1} Overview}
...
% ================================================================
\subsubsection{State Space \texorpdfstring{$\Omega(K_1)$}{\Omega(K_1)}}
...
% ================================================================
\subsubsection{Boundary \texorpdfstring{$\partial\Omega(K_1)$}{\partial\Omega(K_1)}}
...
% ================================================================
\subsubsection{Axes \texorpdfstring{$A(K_1)$}{A(K_1)}}
...
% ================================================================
\subsubsection{Potentials \texorpdfstring{$P(K_1)$}{P(K_1)}}
...
% ================================================================
\subsubsection{Thresholds \texorpdfstring{$\Theta(K_1)$}{\Theta(K_1)}}
...
% ================================================================
\subsubsection{Flows \texorpdfstring{$J(K_1)$}{J(K_1)}}
...
% ================================================================
\subsubsection{Cycles \texorpdfstring{$C(K_1)$}{C(K_1)}}
...
Thus:
\[
\lambda(K_1) \text{ is the local ordering coordinate.}
\]

% ================================================================
\subsubsection{Ordering Coordinate \texorpdfstring{$\lambda(K_1)$}{lambda(K_1)}}
...
% ================================================================
\subsubsection{Continuumness \texorpdfstring{$k(K_1)$}{k(K_1)}}
...
% ================================================================
\subsubsection{Structural Tension \texorpdfstring{$T(K_1)$}{T(K_1)}}
...
% ================================================================
\subsubsection{Energy \texorpdfstring{$E(K_1)$}{E(K_1)}}
...
% ================================================================
\subsubsection{Operators on \texorpdfstring{$K_1$}{K_1} (\texorpdfstring{$\Psi$}{\Psi}, \texorpdfstring{$\Phi$}{\Phi}, \texorpdfstring{$\Lambda$}{\Lambda}, \texorpdfstring{$U$}{U}, \texorpdfstring{$\Chi$}{\Chi})}
...
% ================================================================
\subsubsection{Processes on \texorpdfstring{$K_1$}{K_1}}
...
% ================================================================
\subsubsection{Predictions for \texorpdfstring{$K_1$}{K_1}}

The model currently frames the following bounded hypotheses: \begin{enumerate}
    ...
    \item no domain-level temporal phenomena are promoted at $K_1$;
    \item collapse under excessive gradients is scoped;
    \item all $K_1$ continua must embed into their $M_1$ meta-space.
\end{enumerate}

% ================================================================
\subsubsection{Experiments for \texorpdfstring{$K_1$}{K_1}}

Indirect tests:
\begin{itemize}
    \item scoped generality of 1D gradient-collapse behaviour in physical,
...
% ================================================================
\subsubsection{Collapse and Death of \texorpdfstring{$K_1$}{K_1}}
...
\begin{enumerate}
    \item scoped presence of continuity thresholds,
    \item absence of nontrivial cycles,
    \item absence of promoted domain-level physical time,
...
% ================================================================
\subsubsection{Branching / Ontological Position of \texorpdfstring{$K_1$}{K_1}}
