...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k4
% ================================================================
% ==== FILE: content/experiments/experiments_k4
% ================================================================
...
The central goal is to specify a protocol for empirically probing:
...
\begin{enumerate}
    \item \textbf{test the emergence of the membrane boundary
          $\partial\Omega(K_4)$.}
    ...
    \item \textbf{test the core flows}
    ...
    \item \textbf{supports conditions for proto-excitability} (early $A_{\mathrm{exc}}$).
          probe pre-spike dynamics and early electrical instabilities.
...
\paragraph{Core Prediction protocol:}
...
\paragraph{Experimental protocol review:}
...
The proposed experiments for $K_4$ probe:
...
These proposed protocol outputs would anchor, if completed and source-bound, the $K_4$ level and test the
