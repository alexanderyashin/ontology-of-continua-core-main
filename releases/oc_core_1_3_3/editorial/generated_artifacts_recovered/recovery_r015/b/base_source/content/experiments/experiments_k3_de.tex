...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k3
% ================================================================
% ==== FILE: content/experiments/experiments_k3
% ================================================================
...
and transformation of chemical continua and tests the theoretical
...
\begin{enumerate}
    \item \textbf{test the structure of $\Omega(K_3)$ as the space of
    ...
    \item \textbf{test the operator $F_{2 \rightarrow 3}$.}
          supports the transition from purely physical continua (K₂) to chemical
...
\begin{enumerate}
    ...
    \item test the existence of a minimum energy input
...
\begin{enumerate}
    ...
    \item Verify tension-driven regime changes predicted by Core:
          ...
          \]
    \item supports existence of alternative low-threshold pathways
          (catalysis).
\end{enumerate}
...
The Core currently frames the following bounded hypotheses: \begin{itemize}
...
\subsubsection{Type~VII Experiments: protocol review of the Operator $F_{2\rightarrow 3}$}
...
\begin{enumerate}
    ...
    \item support of chemical axis birth through stability diagrams,
...
The experimental programme for $K_3$ supports:
...
provide an illustrative evidence route for the emergence of $K_4$.
