...
appendix, Lean-oriented formalization inventory, finite semantic checks, and proof sheets are then used as
...
retrospective replay evidence tables, and the methods companion. This route explains
why physics, chemistry, biology, systems, and mathematics lanes have different
evidentiary force, and why bounded replay rows do not become broad bounded cross-domain
validation claims.
...
\hline
Evaluate the release for review & Front matter; claim boundary; theorem/proof integration; reviewer objections & Proof sheets, Lean-oriented formalization inventory, finite semantic checks, and claim register \\
...
Inspect empirical force & Domain evidence; bounded replay QA; methods companion & Retrospective replay table, validation report, negative controls, falsifiers \\
