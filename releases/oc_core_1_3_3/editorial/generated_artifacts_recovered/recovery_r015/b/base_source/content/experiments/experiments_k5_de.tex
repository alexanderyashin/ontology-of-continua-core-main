...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k5
% ================================================================
% ==== FILE: content/experiments/experiments_k5
% ================================================================

\subsubsection{Experiments for \texorpdfstring{$K_5$}{K5}}
...
to early neural continua and test the full structure of
...
Biology~U0.3b and the K5 construction route, covering excitability, regulation,
cycles, collapse, and the birth of proto-networks.



\subsubsection{Objectives of the \texorpdfstring{$K_5$}{K5} Experimental Programme}

Experiments aim to probe:
...
\subsubsection{Type~I Experiments: Emergence of Membrane Potential \texorpdfstring{$\Delta V$}{ΔV}}
...
\subsubsection{Type~II Experiments: Ion Channel Opening, Closing and Gating}
...
\subsubsection{Type~III Experiments: Proto-Spike Dynamics}
...
\subsubsection{Type~IV Experiments: Patch-Dependent Electrical Dynamics}
...
\begin{itemize}
    ...
    \item Proto-spike propagation may hält or amplify at patch boundaries.
    \item Patch flickering produces stochastic excitability windows.
\end{itemize}



\subsubsection{Type~V Experiments: Excitation--Recovery Cycles}

$K_5$ motivates a test for the existence of structured cyclic dynamics
...
\subsubsection{Type~VI Experiments: Stochastic Logic and Early Regulatory Behaviour}
...
\subsubsection{Type~VII Experiments: Proto-Networks and Early Connectivity}
...
\begin{itemize}
    \item Emergence of primitive network motifs (chains, bifürcations).
...
\subsubsection{Type~VIII Experiments: Collapse of \texorpdfstring{$K_5$}{K5} Continua}
...
Mapping these thresholds tests the survivability range
...
Experiments for $K_5$ test the structural core of early excitability:
...
Together, these experimental results supports that $K_5$ is a
genuine excitable continuum and provide an illustrative evidence route for the emergence of $K_6$ cognitive dynamics.
