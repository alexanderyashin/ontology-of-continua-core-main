...
\label{sec:r008-continuum-problem}
...
formalization layer binds selected claims to proof sheets, formalization inventory for source inspection,
...
complete bounded replay evidence. It does not ask a reader to treat internal build
...
\label{sec:r008-conceptual-background}
