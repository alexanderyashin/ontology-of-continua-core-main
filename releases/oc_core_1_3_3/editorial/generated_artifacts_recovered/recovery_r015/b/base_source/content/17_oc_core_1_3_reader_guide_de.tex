...
\section{Wie man Core 1.3.3 liest}

Core 1.3.3 ist für mehrere Leserschaften zugleich konzipiert, und die Struktur des Bandes spiegelt
...
Der kurze Journal-Kernartikel, der aus Core 1.3.3 extrahiert wurde, verfolgt einen anderen Zweck.
...
wie sich die vorliegende Fassung zum übernommenen Core-1.2-Korpus und zu späterer OC/the methodological staging framework-Arbeit
verhält.
...
Ausleitungssystem in the release engineering pipeline.
...
klein ist.
Core 1.3.3 versucht, beides zu vermeiden.
