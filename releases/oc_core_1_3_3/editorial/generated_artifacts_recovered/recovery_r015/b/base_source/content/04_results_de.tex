...
Dieser Abschnitt fasst die zentralen strukturellen Resultate zusammen, die aus dem in Abschnitt~the formal model chapter eingeführten formalen Rahmen folgen.
...
\end{itemize}
Stagnierende oder konstante Komplexität entspricht fein austarierten Dynamiken unterhalb kritischer Schwellen; dieses Regime ist jedoch im Allgemeinen instabil (siehe Satz~source label theorem no eternal stabilisation).
