...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/experiments/experiments_k6
% ================================================================
% ==== FILE: content/experiments/experiments_k6
% ================================================================
...
They operationalise predictions of the the K6 construction route, including
...
The goals of the experimental programme are to probe:
...
Experiments for $K_6$ test the core architecture of cognitive continua:
...
Together, these results provide proposed empirical and computational protocol context for the transition $K_6 \rightarrow K_7$ and the
