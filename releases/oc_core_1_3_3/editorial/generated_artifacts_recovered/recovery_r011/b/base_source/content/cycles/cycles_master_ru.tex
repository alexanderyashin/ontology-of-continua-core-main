...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/cycles/cycles_master.tex
% ================================================================
...
levels \(K_0\)–\(K_{12}\), stated at the model-vocabulary level before domain-specific interpretation.
...
OC defines several scoped metrics on cycles, needed for expressing
...
of continua across the declared release domains.
