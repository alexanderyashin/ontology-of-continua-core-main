...
% ---------------------------------------------------------------
\subsubsection{Nature of \texorpdfstring{$K_0$}{K_0} Processes}
...
% ---------------------------------------------------------------
\subsubsection{The Three Fundamental Proto-Processes}

There are exactly three types of processes admissible on $K_0$,
corresponding to its three structural components.

% -----------------
\paragraph{1. Distinction-Generation Process (\texorpdfstring{$\Psi_0$}{\Psi_0}).}
...
% -----------------
\paragraph{2. Relational Reconfiguration Process (\texorpdfstring{$\Phi_0$}{\Phi_0}).}
...
% -----------------
\paragraph{3. Compositional Assembly Process (\texorpdfstring{$\Lambda_0$}{\Lambda_0}).}
...
% ---------------------------------------------------------------
\subsubsection{Absence of Time and Flows}
...
% ---------------------------------------------------------------
\subsubsection{Structural Tension and Thresholds on \texorpdfstring{$K_0$}{K_0}}
...
% ---------------------------------------------------------------
\subsubsection{Birth of the First Axis and the Transition to \texorpdfstring{$K_1$}{K_1}}
...
% ---------------------------------------------------------------
\subsubsection{The scoped Schema for \texorpdfstring{$K_0$}{K_0} Processes}

$K_0$ processes instantiate a truncated form of the scoped process schema
(valid for all $K$):

\[
\begin{aligned}
\text{distinction-generation}
&\xrightarrow{\Psi_0} \text{relational reconfiguration}\\
&\xrightarrow{\Phi_0} \text{compositional assembly}\\
&\xrightarrow{\Lambda_0} \text{birth of the first axis}.
\end{aligned}
\]
...
% ---------------------------------------------------------------
\subsubsection{Death of \texorpdfstring{$K_0$}{K_0} Processes}
