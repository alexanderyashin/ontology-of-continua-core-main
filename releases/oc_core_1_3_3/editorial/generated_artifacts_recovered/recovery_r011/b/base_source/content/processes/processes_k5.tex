...
\left(
\begin{aligned}
&\Omega(K_5), \partial\Omega(K_5), A_{\text{exc}}, A_{\text{grad}}, A_{\text{ion}},\\
&P_{\text{exc}}, P_{\text{ion}}, P_{\text{chem}}, J_{\text{ion}}, J_{\text{pump}},\\
&J_{\text{leak}}, J_{\text{met}}, C_{\text{spike}}, C_{\text{recovery}}, C_{\text{energy}},\\
