...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/cycles/cycles_k5.tex
% ================================================================
% ==== FILE: content/cycles/cycles_k5.tex
% ================================================================

\subsubsection{Cycles on \texorpdfstring{$K_5$}{K_5}}
\label{sec:cycles-k5}
...
\subsubsection{Overview of Cycle Structure on \texorpdfstring{$K_5$}{K_5}}

According to the representability теорему for neurons (the corresponding derivation note),
...
\subsubsection{1. Action-Potential Cycles $C_{\mathrm{spike}}$}
...
\subsubsection{2. Subthreshold Oscillatory Cycles $C_{\mathrm{sub}}$}
...
\subsubsection{3. Refractory-Reset Cycles $C_{\mathrm{refrac}}$}
...
\subsubsection{4. Channel-Gating Cycles $C_{\mathrm{gate}}$}
...
\subsubsection{5. Calcium and Second-Messenger Cycles $C_{\mathrm{Ca}}$}
...
\subsubsection{6. Synaptic Potentiation/Depression Cycles $C_{\mathrm{syn}}$}
...
\subsubsection{7. Network-Level Cycles $C_{\mathrm{net}}$ (Continuum $K_5'$)}

Using the representability теорему for neural networks (the corresponding derivation note),
...
\subsubsection{Metrics of Cycles on \texorpdfstring{$K_5$}{K_5}}
...
\subsubsection{Collapse of \texorpdfstring{$C(K_5)$}{C(K_5)}}
...
\subsubsection{Continuity from \texorpdfstring{$K_4$}{K_4} to \texorpdfstring{$K_5$}{K_5}}
