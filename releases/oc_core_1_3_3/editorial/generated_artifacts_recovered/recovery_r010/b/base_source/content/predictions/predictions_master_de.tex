...
\begin{enumerate}
    \item \textbf{scoped} (independent of domain);
...
% ---------------------------------------------------------------
\subsection{Bounded Prediction Constraints}
...
\begin{itemize}
    \item a formal route for deriving scoped predictions at declared K-levels,
    \item structural templates linking potentials, flows and thresholds,
    \item a bounded account of dimensional transitions,
