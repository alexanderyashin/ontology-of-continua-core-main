...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/processes/processes_k1.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{Definition of a \texorpdfstring{$K_1$}{K_1} Process}
...
% ---------------------------------------------------------------
\subsubsection{Types of Processes on \texorpdfstring{$K_1$}{K_1}}

There are four canonical classes of processes at this level.

% -----------------
\paragraph{1. Evolution Through Flows (\texorpdfstring{$J_1$}{J_1}).}
...
The scoped evolution equation is:
\[
...
% ---------------------------------------------------------------
\subsubsection{Role of Operators on \texorpdfstring{$K_1$}{K_1}}
...
\begin{itemize}
    ...
    \item $U$ — scoped operator governing $k(t)$ evolution,
...
% ---------------------------------------------------------------
\subsubsection{Continuumness Evolution}
...
% ---------------------------------------------------------------
\subsubsection{Structural Tension and Threshold-Crossing Processes}
...
% ---------------------------------------------------------------
\subsubsection{Emergence of \texorpdfstring{$K_2$}{K_2} Processes}
...
% ---------------------------------------------------------------
\subsubsection{Death of \texorpdfstring{$K_1$}{K_1} Processes}
