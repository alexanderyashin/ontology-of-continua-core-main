...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/predictions/predictions_k1.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{P1: Predictions Concerning Axes and Time}
...
% ---------------------------------------------------------------
\subsubsection{P2: Predictions Concerning Fields and Regularity}
...
% ---------------------------------------------------------------
\subsubsection{P3: Predictions Concerning Dynamics and Evolution}
...
\paragraph{(P3.2) scoped Relaxation Prediction.}
...
% ---------------------------------------------------------------
\subsubsection{P5: Predictions Concerning Collapse and Boundaries}
...
% ---------------------------------------------------------------
\subsubsection{P6: Predictions Concerning Transitions and M-Spaces}

\paragraph{(P6.1) Necessary Condition for \texorpdfstring{$K_1 \to K_2$}{K_1 \to K_2}.}
