...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/experiments/experiments_k1
% ================================================================
% ==== FILE: content/experiments/experiments_k1
% ================================================================
...
its experimental programme tests the basic empirical and analytic
tests that test the continuum formalism and its evolution operator
$E(K_1)$.


\subsubsection{Objectives of \texorpdfstring{$K_1$}{K_1} Experiments}
...
\begin{enumerate}
    ...
    \item \textbf{Reproducibility of the evolution operator.}
          Numerical and analytical experiments must test the
          operator $E(K_1)$ as defined in Core~1.3.3.
\end{enumerate}


\subsubsection{Type~I Experiments: Continuity and Smoothness}
...
\subsubsection{Type~II Experiments: Flow Stability and Tension}
...
\begin{itemize}
    \item testing a stable flow $J_1^{\mathrm{stable}}(x)$ with minimal tension;
...
Such tests test the definition of stability encoded in the Core.


\subsubsection{Type~III Experiments: Existence of the Trivial Cycle}
...
These experiments test the existence of time at $K_1$ in the precise
sense of a closed minimal cycle.


\subsubsection{Type~IV Experiments: Threshold Dynamics}
...
These tests supports the role of $\Theta_1$ as an existence and stability
threshold.


\subsubsection{Type~V Experiments: protocol review of \texorpdfstring{$E(K_1)$}{E(K_1)}}
...
Experiments on $K_1$ test the foundations of physical dynamics in the
