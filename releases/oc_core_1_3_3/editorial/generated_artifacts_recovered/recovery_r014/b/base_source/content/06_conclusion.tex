...
\paragraph{Complexity growth remains a bounded hypothesis.}
New axes, expanded state spaces and stable cycles increase structural richness.
A continuum that appears to stop evolving structurally is treated as a case requiring the named stabilization, collapse, or modeling-assumption test; the present release does not promote a scoped no-stabilization theorem.
...
\begin{itemize}
    \item expanded public proof sheets and mechanized proof coverage for claims not covered by the current Lean-oriented formalization inventory;
