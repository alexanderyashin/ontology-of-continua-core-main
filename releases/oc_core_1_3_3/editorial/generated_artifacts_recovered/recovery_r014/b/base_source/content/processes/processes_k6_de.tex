...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/processes/processes_k6.tex
% ================================================================
...
Error estimate:
\[
e_{\mathrm{err}} = D(x_{\text{new}}, x_{\text{old}}).
\]
...
The S-module gives a scoped minimal unit of meaning:
\[
...
\[
T_6 = F(e_{\mathrm{err}}, C_{\text{cons}}, \Theta_{\text{cog}}, J_{\text{info}}, P_{\text{cog}}).
\]
