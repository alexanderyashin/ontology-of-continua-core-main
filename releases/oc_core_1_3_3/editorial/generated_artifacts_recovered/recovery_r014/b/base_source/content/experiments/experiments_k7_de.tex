...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k7
% ================================================================
% ==== FILE: content/experiments/experiments_k7
% ================================================================
...
Experiments at this level aim to probe:
...
\begin{enumerate}
    ...
    \item Social dilemmas (öffentlich goods, commons problems).
    \item Manipulating:
          \begin{itemize}
...
\begin{itemize}
    ...
    \item Exceeding stability threshold triggers institutional collapse:
          ...
          \]
    \item Recovery requires re-testing $C_{\mathrm{inst}}$ cycles.
\end{itemize}
...
Experiments for $K_7$ empirically test the structural theory of
social continua:
...
Together, these experiments form an illustrative evidence route for the
