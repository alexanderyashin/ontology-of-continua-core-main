...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/experiments/experiments_k8
% ================================================================
% ==== FILE: content/experiments/experiments_k8
% ================================================================
...
Experiments at this level test the structure, thresholds,
...
\begin{itemize}
    ...
    \item detection of scoped invariant patterns.
\end{itemize}



\subsubsection{Objectives of the \texorpdfstring{$K_8$}{K_8} Experimental Programme}

The experimental goals are to test the formal structure:
...
\subsubsection{Type~I Experiments: Written Symbolic Systems and $\Theta_{\mathrm{sym}}$}
...
\subsubsection{Type~II Experiments: Infrastructure Dynamics and Collapse Thresholds}
...
\subsubsection{Type~III Experiments: Scientific Cycles and Paradigm Transitions}
...
\begin{itemize}
    \item Paradigm transitions occur when epistemic tension exceeds
          $\Theta_{\mathrm{sci}}$.
    \item Knowledge systems can exhibit growth-collapse-renewal cycles under declared conditions.
    \item The transition $K_8 \to K_9$ requires coherent meta-theoretical integration.
\end{itemize}



\subsubsection{Type~IV Experiments: Technological Acceleration and Stability}
...
\subsubsection{Type~V Experiments: Information Density, Cohesion, and Collapse}
...
\subsubsection{Type~VI Experiments: Demography, Resources, and Long-Range Flows}
...
\subsubsection{Type~VII Experiments: Civilisational Collapse and Reorganisation}
...
\begin{enumerate}
    ...
    \item Comparative analysis of criticism routes
...
Experiments for $K_8$ test systems-scale research for the Ontology of Continua:
...
\begin{itemize}
    ...
    \item scoped signatures of collapse and reorganisation.
\end{itemize}

These results form an illustrative evidence route for the transition $K_8 \rightarrow K_9$
and test the structural unity of civilisational continua.
