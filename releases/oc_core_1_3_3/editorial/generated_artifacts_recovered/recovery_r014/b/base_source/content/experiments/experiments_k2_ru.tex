...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/experiments/experiments_k2
% ================================================================
% ==== FILE: content/experiments/experiments_k2
% ================================================================
...
\subsubsection{Objectives of \texorpdfstring{$K_2$}{K_2} Experiments}
...
\begin{enumerate}
    ...
    \item \textbf{protocol review of the operator $F_{1 \rightarrow 2}$.}
...
\subsubsection{Type~I Experiments: Percolation and Connectivity}
...
\begin{enumerate}
    ...
    \item test the monotonicity of the connectivity operator:
          \[
...
\subsubsection{Type~II Experiments: Emergence of the Physical Axis}
...
\subsubsection{Type~III Experiments: Energetic Thresholds $\Theta_{\mathrm{phys}}$}
...
These Experiments probe the role of energetic thresholds in the Core model.



\subsubsection{Type~IV Experiments: BKT-Type Transitions}
...
\begin{itemize}
    ...
    \item measure the scoped jump in the helicity modulus;
    \item compare the behaviour with the predicted threshold structure in
          the Core (C.1-8: birth of the phase axis).
\end{itemize}

This experiment tests the mechanism of threshold-induced dimension change.



\subsubsection{Type~V Experiments: Coherence Collapse}
...
\subsubsection{Type~VI Experiments: protocol review of the Operator $F_{1\rightarrow 2}$}
...
These experiments provide proposed empirical-test grounding for the
...
The $K_2$ experimental programme tests:
...
Because $K_2$ is the modeling bridge into physical-continuum examples under declared assumptions,
