...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/experiments/experiments_k9
% ================================================================
% ==== FILE: content/experiments/experiments_k9
% ================================================================
...
Experiments for $K_9$ test the structure of meta-theories,
...
\begin{itemize}
    ...
    \item domänenübergreifend comparative studies.
\end{itemize}
...
The aim is to empirically test the $K_9$ structure:
...
\begin{itemize}
    \item Paradigms collapse when
          ...
          \]
    \item Coherence decay follows scoped patterns across sciences.
...
\begin{itemize}
    ...
    \item Functorial collapse patterns are compared across declared disciplines.
...
Experiments for $K_9$ test the structural unity of scientific and
...
These experimental lines states the protocol basis for the
existence and stability of $K_{10}$ and supports the structural
