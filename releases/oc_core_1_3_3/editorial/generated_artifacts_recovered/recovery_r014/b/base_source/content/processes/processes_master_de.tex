...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: DE
% SOURCE_EN_REF: content/processes/processes_master.tex
% ================================================================
...
Processes arise through the general operators:
...
Within the declared operator vocabulary, a reviewed process may be represented as a composition of these:
...
We classify processes into six scoped families:
...
% ---------------------------------------------------------------
\subsection{Process Schema Under Declared Scope}

This public model treats the following as a proposed Process Schema Under Declared Scope:
...
At each level, processes inherit the scoped schema but operate on
...
M-processes obey the same scoped schema but take place in the
superstructure where $K_0$--$K_{12}$ reside as objects.

% ---------------------------------------------------------------
\subsection{Summary}

This module provides the scoped definition and classification of processes
across all levels of the Ontology of Continua.
It establishes the formal conditions for birth, evolution, stability,
and death of processes, and clarifies the role of general operators.
