...
Status: `PASS`
Baseline revision: `recovery_r013`
Candidate revision: `recovery_r014`
Artifact hash: `98d895540dafbb8497ab2b998dd31a829a0b65ad48531743e3966d79a9ab6522`
...
- `explained_page_reduction_total`: 5
...
- `PASS` `old_public_page_baseline::master_monograph`: baseline=`650` candidate=`650`
- `PASS_EXPLAINED` `old_public_page_baseline::methods_repro_companion`: baseline=`17` candidate=`10`
- `PASS_EXPLAINED` `old_public_page_baseline::release_guide`: baseline=`9` candidate=`8`
- `PASS_EXPLAINED` `old_public_page_baseline::reviewer_attack_response_map`: baseline=`19` candidate=`11`
- `PASS` `assembly_page_delta::journal_core_article`: baseline=`9` candidate=`13`
- `PASS_EXPLAINED` `assembly_page_delta::master_monograph`: baseline=`706` candidate=`650`
- `PASS` `assembly_page_delta::methods_repro_companion`: baseline=`9` candidate=`10`
- `PASS_EXPLAINED` `assembly_page_delta::release_guide`: baseline=`9` candidate=`8`
- `PASS` `assembly_page_delta::reviewer_attack_response_map`: baseline=`9` candidate=`11`
