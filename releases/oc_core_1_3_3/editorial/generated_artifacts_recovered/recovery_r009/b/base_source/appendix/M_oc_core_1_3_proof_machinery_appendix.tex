\section{Appendix M -- Proof Machinery}
...
\item \textbf{Dependency route:} the proof sheet, Lean declaration, finite case, or replay row must be named where it carries support
