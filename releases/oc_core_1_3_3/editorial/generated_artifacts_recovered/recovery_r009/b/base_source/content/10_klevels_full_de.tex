...
ausführlich verteilten Quellen in archival source corpus sowie den Läufen Physik, Chemie,
Biologie, Kognition und Soziales integriert.
Im Gegensatz zu Abschnitt~the formal model chapter, der einen kompakten Überblick bot,
erweitert das vorliegende Kapitel jedes Niveau zur vollständigen strukturellen
genauen Definition.

Core~1.3.3 fixiert die Hierarchie als \(K_0\)–\(K_{12}\), weil das öffentliche
...
Eine globale Übersicht ist in Tabelle~source label table klevels summary dargestellt.
