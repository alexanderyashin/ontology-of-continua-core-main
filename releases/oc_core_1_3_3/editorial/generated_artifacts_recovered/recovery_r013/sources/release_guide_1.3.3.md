...
<!-- PUBLICATION_TRANSLATOR_R013: public prose checked through a governed local V-model review trace; no unmanaged local-LLM call. -->
...
Tables in this package are treated as argument surfaces rather than raw data dumps. A promoted reader-facing table must have a readable layout, a captioned scientific role, and a source or evidence anchor; internal probe files used to test table geometry remain outside the publication package.
