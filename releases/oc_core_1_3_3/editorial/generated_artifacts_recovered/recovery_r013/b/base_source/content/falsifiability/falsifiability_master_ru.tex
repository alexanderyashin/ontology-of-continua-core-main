...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/falsifiability/falsifiability_master.tex
% ================================================================
...
This chapter summarizes the scoped falsifiability programme for
declared continuum classes $K_0$–$K_{12}$ and connects it to the general operators
...
\begin{enumerate}
    ...
    \item \textbf{Embedding-space violations:}
          ...
          falsified by the embedding-constraint falsifier.
    ...
    \item \textbf{Failure of monotonic dimension теорему:}
...
therefore constitute scoped falsifiability conditions.



% ================================================================
\subsection{Bounded Falsifiability Criteria}
% ================================================================

Across declared continuum classes, the following scoped conditions provide
a bounded falsification route:

\paragraph{(F1) Incoherent State Space \texorpdfstring{$\Omega$}{\Omega}.}
...
\paragraph{(F2) Impossible Axes \texorpdfstring{$A$}{A}.}
...
\paragraph{(F9) Diverging structural tension \texorpdfstring{$T$}{T}.}
If $T(t)$ grows without bound and no axis, boundary, or potential
reconfiguration reduces it, collapse follows under the declared model.
...
This scoped generality is a central scientific virtue of OC.
...
The scoped falsifiability programme for the Ontology of Continua is
...
\section{Overview}
% REVIEW MODULE - RELEASE-BOUND OVERVIEW
