...
% ================================================================
\subsection{declared model structure Across All Levels}
% ================================================================
...
\begin{itemize}
    ...
    \item K12 - upper-coherence taxonomy candidates for declared lower-level architectures.
\end{itemize}
...
\begin{itemize}
    ...
    \item supply the dimensional ladder necessary for bounded cross-domain applicability;
    \item constrain the evolution of continua via admissibility
          conditions;
    \item provide a bounded cross-domain modeling grammar where assumptions and evidence are declared.
\end{itemize}
