...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/predictions/predictions_k9.tex
% ================================================================
...
% ---------------------------------------------------------------
\subsubsection{P1: Predictions on the Birth of \texorpdfstring{$K_9$}{K_9}}
...
% ---------------------------------------------------------------
\subsubsection{P2: Predictions Concerning Axes \texorpdfstring{$A^9$}{A^9}}
...
% ---------------------------------------------------------------
\subsubsection{P3: Predictions for Potentials \texorpdfstring{$P^9$}{P^9}}
...
% ---------------------------------------------------------------
\subsubsection{P4: Predictions for Flows \texorpdfstring{$J^9$}{J^9}}
...
% ---------------------------------------------------------------
\subsubsection{P5: Predictions for Cycles \texorpdfstring{$C^9$}{C^9}}

\paragraph{(P9.16) scoped Theory Cycle.}
...
% ---------------------------------------------------------------
\subsubsection{P6: Predictions for Stability and \texorpdfstring{$k(K_9)$}{k(K_9)}}
...
% ---------------------------------------------------------------
\subsubsection{P7: Predictions for Transition to $K_{10}$}
...
\begin{itemize}
    ...
    \item scoped patterns of theory evolution, collapse and unification,
