...
\small
\textbf{Publikationsrolle.} Dieser Band ist die kanonische Master-Monographie für OC Core 1.3.3.
...
{\small Archivierter Vorgängernachweis: Zenodo DOI 10.5281/zenodo.19967310}
\end{center}
\end{titlepage}

\begin{abstract}
Core 1.3.3 ist die quellenpriorisierte, erneut validierte Master-Monographie der Ontology of Continua.
...
Publikation, Begutachtung, Übersetzung und spätere Projektion in the methodological staging framework, Produkt-, Geschäfts- und
öffentliche Kanäle.
