...
\item явное противоречие promoted claim сначала помечает refutation-candidate
      или surface-contradiction case для science-state register audit;
...
доказательства, а не замену канонической science-state register-лексики научного класса и
closure-verdict. Release verdicts вроде \texttt{bounded evidence recorded} и
...
\item Axiomatic statements являются admitted premises или identity rules. Они
      могут находиться внутри маршрута bounded theorem route как named
      assumptions, но сама аксиома от этого не превращается в proved theorem.
\item Derived statements отображаются в bounded theorem route when the
      support route is closed.
\item Empirical statements отображаются в bounded theorem route only after
...
Канонический science-state register является научной authority выпуска, а corpus науки,
...
closures могут быть \texttt{bounded evidence recorded} as frame support, но они не становятся
...
перемаркировываются как proof-routed \texttt{bounded evidence recorded} rows, если только не
...
вне public \texttt{bounded evidence recorded} authority.
