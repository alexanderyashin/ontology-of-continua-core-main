...
% SOURCE_LANGUAGE: EN
% TARGET_LANGUAGE: RU
% SOURCE_EN_REF: content/predictions/predictions_k4.tex
% ================================================================
...
\begin{itemize}
    ...
    \item collapse modes discovered in chemistry construction route (pH-collapse, osmotic burst, waste–pressure loop).
\end{itemize}

The predictions are grouped into seven families.

% ---------------------------------------------------------------
\subsubsection{P1: Predictions Concerning Membrane Structure and Stability}
...
This regime is a scoped near-critical phenomenon absent in $K_3$.
...
% ---------------------------------------------------------------
\subsubsection{P2: Predictions Concerning Internal Chemical Organization}
...
identified in chemistry construction route.
...
% ---------------------------------------------------------------
\subsubsection{P3: Predictions Concerning Flows and Transport}
...
% ---------------------------------------------------------------
\subsubsection{P4: Predictions Concerning Cycles and Non-Equilibrium Dynamics}
...
% ---------------------------------------------------------------
\subsubsection{P5: Predictions Concerning Collapse, Death and Threshold Behaviour}
...
% ---------------------------------------------------------------
\subsubsection{P6: Predictions Concerning Transition to \texorpdfstring{$K_5$}{K_5}}
...
% ---------------------------------------------------------------
\subsubsection{P7: Predictions Concerning Evolution and Higher-Level Structure}
...
\begin{itemize}
    ...
    \item membrane flickering as a scoped near-critical regime;
    \item internal metabolic loops, redox cycles and buffering systems;
    \item active transport and gradient maintenance;
    \item three scoped collapse modes: pH-collapse, osmotic burst, waste–pressure loop;
