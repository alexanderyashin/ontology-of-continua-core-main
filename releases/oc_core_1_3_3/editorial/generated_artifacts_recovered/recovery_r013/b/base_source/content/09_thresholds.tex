...
% Extended Threshold Landscape — Core 1.3.3
% ====================================================================
...
Thresholds are treated as cross-domain model motifs: they apply to physical, chemical, biological,
cognitive, social and theoretical continua throughout the hierarchy K0--K12.
...
OC distinguishes seven recurring classes of thresholds. This taxonomy was
stabilised in archival source corpus and clarified across the domain runs.
...
\begin{itemize}
    ...
    \item patch–level heterogeneity at the boundary
          (cf.~the boundary geometry chapter).
\end{itemize}
...
the boundary geometry chapter, the threshold landscape completes the
