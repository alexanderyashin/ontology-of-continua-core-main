...
Status: `PASS`
Baseline revision: `recovery_r012`
Candidate revision: `recovery_r013`
Artifact hash: `ade8511ea0862bf3af5f8dc3f4cb4dfaedf759f1f304c7e6ec2a2a8692695d7d`
...
- `explained_page_reduction_total`: 4
...
- `PASS` `old_public_page_baseline::master_monograph`: baseline=`650` candidate=`706`
- `PASS_EXPLAINED` `old_public_page_baseline::methods_repro_companion`: baseline=`17` candidate=`9`
- `PASS` `old_public_page_baseline::release_guide`: baseline=`9` candidate=`9`
- `PASS_EXPLAINED` `old_public_page_baseline::reviewer_attack_response_map`: baseline=`19` candidate=`9`
- `PASS` `assembly_page_delta::journal_core_article`: baseline=`9` candidate=`9`
- `PASS_EXPLAINED` `assembly_page_delta::master_monograph`: baseline=`707` candidate=`706`
- `PASS` `assembly_page_delta::methods_repro_companion`: baseline=`9` candidate=`9`
- `PASS` `assembly_page_delta::release_guide`: baseline=`9` candidate=`9`
- `PASS` `assembly_page_delta::reviewer_attack_response_map`: baseline=`9` candidate=`9`
